...
public class Config extends AbstractConfiguration<TokenManagerPlugin> {
  ...
  @Getter private String onlineMode;
  @Getter private boolean altPrevention;
  @Getter private int defaultBalance;
  @Getter private long sendMin;
  @Getter private long sendMax;
  @Getter private boolean openSelectedEnabled;
  @Getter private String openSelectedShop;
  @Getter private String confirmPurchaseTitle;
  @Getter private String confirmPurchaseConfirm;
  @Getter private String confirmPurchaseCancel;
  @Getter private int clickDelay;
  @Getter private boolean checkInventoryFull;
  @Getter private boolean logPurchases;
  ...
  @Getter private boolean redisEnabled;
  @Getter private String redisServer;
  ...
  protected void loadValues(FileConfiguration configuration) throws Exception {
    ...
    confirmPurchaseTitle =
        configuration.getString("shop.confirm-purchase-gui.title", "Confirm Your Purchase");
    confirmPurchaseConfirm =
        configuration.getString(
            "shop.confirm-purchase-gui.confirm-button",
            "STAINED_CLAY:5 1 name:&a&lBUY lore:&7Price:_&a%price%_tokens");
    confirmPurchaseCancel =
        configuration.getString(
            "shop.confirm-purchase-gui.cancel-button", "STAINED_CLAY:14 1 name:&c&lCANCEL");
    ...
    mysqlUrl =
        configuration.getString("data.mysql.url", "jdbc:mysql://%hostname%:%port%/%database%");
