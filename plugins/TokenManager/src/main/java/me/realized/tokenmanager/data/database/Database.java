...
public interface Database {
   ...
   *
   * @throws Exception If the found table does not have the key column matching with the server mode
   *     (UUID for online/name for offline)
   */
   ...
   * @return instance of {@link OptionalLong} with the player's token balance if found, otherwise
   *     empty
   */
