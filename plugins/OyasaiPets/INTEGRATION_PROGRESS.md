...
### ✅ Step 0: バックアップ作成
- 場所: `/Users/aa/platform/plugins/OyasaiPets/backup/refactor_pre_merge_20260217/`
- 完了日時: 2026-02-17
...
- `SpawnUtils` (object)
- `PetStatus` (enum)
- `PetData`, `LocationData`, `DeathData`, `PetStats`, `TransferRecord`, `BreedInfo`, `PetSnapshot` (data classes)
...
1. リスナークラスの追加（8クラス）
2. コマンドクラスの追加（4クラス）
3. メインプラグインクラス（BigWolfPlugin）の統合
4. plugin.ymlの更新（main classの変更）
5. 旧ファイルの削除
6. ビルド・動作テスト
