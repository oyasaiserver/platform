...
public class ConsumerCommand {
  ...
  protected static void runCommand(final CommandSender player, boolean permission, String[] args) {
    ...
    if (!(player instanceof ConsoleCommandSender)) {
      Chat.sendMessage(
          ...
          Color.DARK_AQUA
              ...
              + Color.WHITE
              + "- "
              + Phrase.build(Phrase.COMMAND_CONSOLE));
      return;
    }
    ...
    if (args.length == 2) {
      ...
      boolean pauseCommand =
          (action.equals("pause") || action.equals("disable") || action.equals("stop"));
      boolean resumeCommand =
          (action.equals("resume") || action.equals("enable") || action.equals("start"));
