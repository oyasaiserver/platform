...
/**
 * Main parser class for CoreProtect commands. Delegates to specialized parser classes for specific
 * functionality.
 */
public class CommandParser {
   ...
   */
  protected static Location parseCoordinates(
      Location location, String[] inputArguments, int worldId) {
   ...
   */
  protected static Integer[] parseRadius(
      String[] inputArguments, CommandSender user, Location location) {
   ...
   * @return The world ID
   */
  protected static int parseWorld(
      String[] inputArguments, boolean processWorldEdit, boolean requireLoaded) {
