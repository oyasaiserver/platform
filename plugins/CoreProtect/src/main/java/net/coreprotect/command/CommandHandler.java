...
public class CommandHandler implements CommandExecutor {
  ...
  public boolean onCommand(
      CommandSender user, Command command, String commandLabel, String[] argumentArray) {
    String commandName = command.getName().toLowerCase(Locale.ROOT);

    if (commandName.equals("core")
        || commandName.equals("coreprotect")
        || commandName.equals("co")) {
      ...
      if (resultc > -1) {
        ...
        if (!permission) {
          if (user.hasPermission("coreprotect.rollback")
            ...
            permission = true;
          } else if (user.hasPermission("coreprotect.networking")
              && corecommand.equals("network-debug")) {
            permission = true;
          }
        }
        ...
        } else if (corecommand.equals("lookup")
            || corecommand.equals("l")
            || corecommand.equals("page")) {
              ...
              try {
                ...
                Chat.sendMessage(
                    ...
                    Color.WHITE
                        ...
                        + Phrase.build(
                            ...
                            "CoreProtect"
                                + (VersionUtils.isCommunityEdition()
                ...
                if (latestVersion != null) {
                  ...
                  Chat.sendMessage(
                      ...
                      Color.DARK_AQUA
                          + Phrase.build(
                              Phrase.LINK_DOWNLOAD, Color.WHITE, "www.coreprotect.net/download/"));
                } else {
                  Chat.sendMessage(
                      user,
                      Color.DARK_AQUA
                  ...
                  Chat.sendMessage(
                      ...
                      Color.DARK_AQUA
                          + Phrase.build(
                              Phrase.LINK_DOWNLOAD, Color.WHITE, "www.coreprotect.net/latest/"));
                }
              } catch (Exception e) {
                e.printStackTrace();
              }
