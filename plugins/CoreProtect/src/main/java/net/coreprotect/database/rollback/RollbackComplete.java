    ...
    try {
      if (preview == 2) {
        Chat.sendMessage(
            ...
            Color.DARK_AQUA
                ...
                + Color.WHITE
                + "- "
                + Phrase.build(Phrase.PREVIEW_CANCELLED));
        return;
      }
        ...
        if (worldedit == 0) {
          ...
          Chat.sendMessage(
              ...
              Color.DARK_AQUA
                  ...
                  + "- "
                  + Phrase.build(
                      Phrase.ROLLBACK_RADIUS,
                      rollbackRadius.toString(),
        ...
        if (location != null) {
          Chat.sendMessage(
              ...
              Color.DARK_AQUA
                  ...
                  + "- "
                  + Phrase.build(
                      Phrase.ROLLBACK_WORLD_ACTION, location.getWorld().getName(), Selector.FIRST));
        }
      }
        ...
        if (actionList.contains(0)) {
          Chat.sendMessage(
              ...
              Color.DARK_AQUA
                  ...
                  + Color.WHITE
                  + "- "
                  + Phrase.build(Phrase.ROLLBACK_WORLD_ACTION, "+inventory", Selector.SECOND));
        ...
        Chat.sendMessage(
            ...
            Color.DARK_AQUA
                ...
                + Phrase.build(
                    ...
                    restrictTargets.toString(),
                    Selector.FIRST,
                    targetType,
                    (targetCount == 1 ? Selector.FIRST : Selector.SECOND))); // include
      }
      ...
      if (excludeList.size() > 0) {
        ...
        for (Map.Entry<Object, Boolean> entry : excludeList.entrySet()) {
          ...
          if (actionList.contains(4) && actionList.contains(11)) {
            if (excludeTarget.equals(Material.FIRE)
                || excludeTarget.equals(Material.WATER)
                || excludeTarget.equals(Material.FARMLAND)) {
              continue;
            }
          }
        ...
        if (excludeCount > 0) {
          Chat.sendMessage(
              ...
              Color.DARK_AQUA
                  ...
                  + Phrase.build(
                      Phrase.ROLLBACK_INCLUDE,
                      excludeTargets.toString(),
                      Selector.SECOND,
                      targetType,
                      (excludeCount == 1 ? Selector.FIRST : Selector.SECOND))); // exclude
        }
      }
        ...
        if (excludeCount > 0) {
          Chat.sendMessage(
              ...
              Color.DARK_AQUA
                  ...
                  + "- "
                  + Phrase.build(
                      Phrase.ROLLBACK_EXCLUDED_USERS,
                      excludeUsers.toString(),
      ...
      if (actionList.contains(5)) {
        modifiedData =
            modifiedData.append(
                Phrase.build(
                    Phrase.AMOUNT_ITEM,
                    NumberFormat.getInstance().format(blockCount),
        ...
        if (itemCount > 0 || actionList.contains(4)) {
          modifiedData =
              modifiedData.append(
                  Phrase.build(
                      Phrase.AMOUNT_ITEM,
                      NumberFormat.getInstance().format(itemCount),
        ...
        if (entityCount > 0) {
          ...
          modifiedData.append(
              Phrase.build(
                  Phrase.AMOUNT_ENTITY,
                  NumberFormat.getInstance().format(entityCount),
      ...
      if (verbose && preview == 0 && !actionList.contains(11)) {
        if (chunkCount > -1 && modifyCount < 3) {
          ...
          modifiedData.append(
              Phrase.build(
                  Phrase.AMOUNT_CHUNK,
                  NumberFormat.getInstance().format(chunkCount),
                  (chunkCount == 1 ? Selector.FIRST : Selector.SECOND)));
          modifyCount++;
        } else if (chunkCount > 1) {
          modifiedDataVerbose.append(
              Phrase.build(
                  Phrase.AMOUNT_CHUNK,
                  NumberFormat.getInstance().format(chunkCount),
                  (chunkCount == 1 ? Selector.FIRST : Selector.SECOND)));
      ...
      Chat.sendMessage(
          ...
          Color.DARK_AQUA
              ...
              + "- "
              + Phrase.build(
                  Phrase.ROLLBACK_MODIFIED,
                  modifiedData.toString(),
                  (preview == 0 ? Selector.FIRST : Selector.SECOND)));
