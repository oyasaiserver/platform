...
public class Lookup extends Queue {
  ...
  public static long countLookupRows(
      Statement statement,
      CommandSender user,
  ...
  public static List<String[]> performPartialLookup(
      Statement statement,
      CommandSender user,
      List<String> checkUuids,
      List<String> checkUsers,
  ...
  protected static List<Object[]> performLookupRaw(
      ...
      boolean restrictWorld,
      boolean lookup) {
    return LookupRaw.performLookupRaw(
        statement,
        user,
        checkUuids,
        checkUsers,
  ...
  // Maintain backward compatibility
  private static ResultSet rawLookupResultSet(
      Statement statement,
      CommandSender user,
      List<String> checkUuids,
      List<String> checkUsers,
      ...
      boolean lookup,
      boolean count) {
    return LookupRaw.rawLookupResultSet(
        statement,
        user,
        checkUuids,
        checkUsers,
