...
public class UserStatement {
        ...
        preparedStmt =
            connection.prepareStatement(
                "INSERT INTO "
                    ...
                    + "user (time, user) VALUES (?, ?) RETURNING rowid");
      } else {
        preparedStmt =
            connection.prepareStatement(
  ...
  public static int getId(PreparedStatement preparedStatement, String user, boolean load)
      throws SQLException {
