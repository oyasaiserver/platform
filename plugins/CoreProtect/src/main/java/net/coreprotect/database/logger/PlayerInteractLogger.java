  ...
  public static void log(
    ...
    try {
      ...
      if (ConfigHandler.blacklist.get(user.toLowerCase(Locale.ROOT)) != null
          || MaterialUtils.getType(type).equals(Material.AIR)
          || MaterialUtils.getType(type).equals(Material.CAVE_AIR)) {
        return;
      }
      ...
      BlockStatement.insert(
          preparedStmt, batchCount, time, userId, wid, x, y, z, type, data, null, null, 2, 0);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
