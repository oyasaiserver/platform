...
public class ContainerRollback extends Rollback {
  ...
  public static void performContainerRollbackRestore(
      Statement statement,
      CommandSender user,
    ...
    try {
      ...
      Queue.queueRollbackUpdate(
          ...
          location,
          lookupList,
          Process.CONTAINER_ROLLBACK_UPDATE,
          rollbackType); // Perform update transaction in consumer
            ...
            public void run() {
              try {
                ...
                ConfigHandler.rollbackHash.put(
                    finalUserString, new int[] {itemCount, modifyCount, entityCount, 1, 1});
              } catch (Exception e) {
                e.printStackTrace();
              }
            }
