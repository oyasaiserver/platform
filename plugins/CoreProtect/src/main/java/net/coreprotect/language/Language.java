...
public class Language {
  ...
  private static final ConcurrentHashMap<Phrase, String> translatedPhrases =
  ...
  public static void loadPhrases() {
    ...
    phrases.put(
        Phrase.DATABASE_LOCKED_3, "To disable database locking, set \"database-lock: false\".");
    phrases.put(
        Phrase.DATABASE_LOCKED_4, "Disabling database locking can result in data corruption.");
    phrases.put(
        Phrase.DATABASE_UNREACHABLE, "Database is unreachable. Discarding data and shutting down.");
    ...
    phrases.put(
        Phrase.HELP_INSPECT_3, "Right-click a block to see what adjacent block was broken.");
    phrases.put(
        Phrase.HELP_INSPECT_4, "Place a block to see what block was broken at that location.");
    phrases.put(Phrase.HELP_INSPECT_5, "Place a block in liquid (etc) to see who placed it.");
    phrases.put(
        Phrase.HELP_INSPECT_6, "Right-click on a door, chest, etc, to see who last used it.");
    ...
    phrases.put(
        Phrase.HELP_PARAMS_4, "Specify a radius area to limit the {lookup|rollback|restore} to.");
    phrases.put(
        Phrase.HELP_PARAMS_5, "Restrict the {lookup|rollback|restore} to a certain action.");
    phrases.put(
        Phrase.HELP_PARAMS_6, "Include specific blocks/entities in the {lookup|rollback|restore}.");
    ...
    phrases.put(
        Phrase.HELP_RADIUS_2, "Examples: [r:10] (Only make changes within 10 blocks of you)");
    ...
    phrases.put(
        Phrase.LOGGING_TIME_LIMIT,
        "Logging time limit reached. Discarding data and shutting down.");
    ...
    phrases.put(
        Phrase.MISSING_LOOKUP_TIME,
        "Please specify the amount of time to {lookup|rollback|restore}.");
    ...
    phrases.put(
        Phrase.NO_DATA_LOCATION,
        "No {data|transactions|interactions|messages} found at this location.");
    ...
    phrases.put(
        Phrase.PATCH_SKIP_UPDATE, "Skipping {table|index} {update|creation|removal} on {0}.");
    ...
    phrases.put(
        Phrase.PREVIEW_TRANSACTION, "You can't preview {container|inventory} transactions.");
    phrases.put(
        Phrase.PRIMARY_THREAD_ERROR, "That API method can't be used on the primary thread.");
    ...
    phrases.put(
        Phrase.ROLLBACK_INCLUDE,
        "{Included|Excluded} {block|entity|target} {type|types}: \"{0}\".");
