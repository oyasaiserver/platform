...
public class EntityUtil {
  ...
  public static void spawnEntity(
      final BlockState block, final EntityType type, final List<Object> list) {
    if (type == null) {
      return;
    }
    Scheduler.runTask(
            ...
            if (entity instanceof Attributable attributable && list.size() >= 6) {
              ...
              for (Object value : attributes) {
                ...
                if (attributeData.get(0) instanceof Attribute) {
                  ...
                  attribute =
                      (Attribute)
                          BukkitAdapter.ADAPTER.getRegistryValue(
                              (String) attributeData.get(0), Attribute.class);
                }
              ...
              if (entity instanceof Creeper creeper) {
                ...
                if (count == 0) {
                  if (abstractVillager instanceof Villager villager) {
                    if (value instanceof String) {
                      value =
                          BukkitAdapter.ADAPTER.getRegistryValue((String) value, Profession.class);
                    }
                  ...
                  if (abstractVillager instanceof Villager villager
                      && (value instanceof Villager.Type || value instanceof String)) {
                    if (value instanceof String) {
                      value =
                          BukkitAdapter.ADAPTER.getRegistryValue(
                              (String) value, Villager.Type.class);
                    }
                  ...
                  for (Object recipes : set) {
                    ...
                    List<List<Map<String, Object>>> metadata =
                        (List<List<Map<String, Object>>>) itemMap.get(1);
                    ...
                    for (Object ingredient : ingredients) {
                      ...
                      @SuppressWarnings("unchecked")
                      ItemStack item =
                          ItemStack.deserialize((Map<String, Object>) ingredientMap.get(0));
                      @SuppressWarnings("unchecked")
                      List<List<Map<String, Object>>> itemMetaData =
                          (List<List<Map<String, Object>>>) ingredientMap.get(1);
                    ...
                    MerchantRecipe merchantRecipe =
                        new MerchantRecipe(result, uses, maxUses, experienceReward);
                    if (recipe.size() > 6) {
                ...
                if (entity instanceof Horse horse) {
                  if (count == 8) {
                    ...
                    @SuppressWarnings("unchecked")
                    org.bukkit.Color set =
                        org.bukkit.Color.deserialize((Map<String, Object>) value);
