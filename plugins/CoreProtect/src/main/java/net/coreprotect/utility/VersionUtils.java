...
public class VersionUtils {
  ...
  public static String getBranch() {
    ...
    try {
      ...
      InputStreamReader reader =
          new InputStreamReader(instance.getClass().getResourceAsStream("/plugin.yml"));
  ...
  public static boolean newVersion(String oldVersion, String currentVersion) {
    ...
    String[] currentVersionSplit = currentVersion.split("\\.");
    return newVersion(
        StringUtils.convertArray(oldVersionSplit), StringUtils.convertArray(currentVersionSplit));
  }
      ...
      if (version.contains(";") || version.contains("+")) {
        ...
        if (worldEditVersion.length >= 2) {
          ...
          if (worldEditVersion[0].length() == 0
              ...
              || newVersion(worldEditVersion[0] + "." + worldEditVersion[1], "7.1")) {
            validVersion = false;
          }
        }
