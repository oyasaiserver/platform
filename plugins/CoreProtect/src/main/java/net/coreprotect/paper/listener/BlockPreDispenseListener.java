...
public final class BlockPreDispenseListener extends Queue implements Listener {
  ...
  public void onBlockPreDispense(BlockPreDispenseEvent event) {
    ...
    if (blockData instanceof Dispenser) {
      ...
      ConcurrentHashMap<String, Long> locationMap =
          ConfigHandler.dispenserNoChange.computeIfAbsent(
              locationKey, k -> new ConcurrentHashMap<>());
      ...
      ConfigHandler.dispenserPending.put(
          locationKey,
          new Object[] {
            eventKey, // The detailed event key
