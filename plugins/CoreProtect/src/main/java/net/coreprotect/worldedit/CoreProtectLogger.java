...
public class CoreProtectLogger extends AbstractDelegateExtent {
  ...
  public <T extends BlockStateHolder<T>> boolean setBlock(BlockVector3 position, T block)
    ...
    BaseBlock baseBlock =
        WorldEditLogger.getBaseBlock(eventExtent, position, location, oldType, oldBlock);
    ...
    ItemStack[] containerData =
        CoreProtectEditSessionEvent.isFAWE()
            ? null
            : ItemUtils.getContainerContents(oldType, null, location);
