  ...
  public void addHoverComponent(Object message, String[] data) {
    try {
      if (Config.getGlobal().HOVER_EVENTS) {
        ...
        // BaseComponent[] displayComponent =
        // TextComponent.fromLegacyText(processComponent(tooltipText));
        ...
        component.setHoverEvent(
            new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(displayComponent)));
  ...
  public void setHoverEvent(Object component, String text) {
    if (Config.getGlobal().HOVER_EVENTS) {
      ((TextComponent) component)
          .setHoverEvent(
              new HoverEvent(
                  HoverEvent.Action.SHOW_TEXT, new Text(TextComponent.fromLegacyText(text))));
    }
  }
