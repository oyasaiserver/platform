...
public final class BlockGroup {
  ...
  public static Set<Material> TRACK_ANY =
      new HashSet<>(Arrays.asList(Material.PISTON_HEAD, Material.LEVER, Material.BELL));
  public static Set<Material> TRACK_TOP_BOTTOM = new HashSet<>(List.of());
  public static Set<Material> TRACK_TOP =
      new HashSet<>(
          Arrays.asList(
              Material.TORCH,
  ...
  public static Set<Material> TRACK_SIDE =
      new HashSet<>(
          Arrays.asList(
              Material.WALL_TORCH,
  ...
  public static Set<Material> CONTAINERS =
      new HashSet<>(
          Arrays.asList(
              Material.JUKEBOX,
              Material.DISPENSER,
  ...
  public static Set<Material> BUTTONS =
      new HashSet<>(
          Arrays.asList(
  ...
  public static Set<Material> PRESSURE_PLATES =
      new HashSet<>(
          Arrays.asList(
  ...
  public static Set<Material> VINES =
      new HashSet<>(Arrays.asList(Material.VINE, Material.WEEPING_VINES, Material.TWISTING_VINES));
  public static Set<Material> AMETHYST = new HashSet<>(List.of());
  public static Set<Material> LIGHTABLES =
      new HashSet<>(Arrays.asList(Material.CAMPFIRE, Material.SOUL_CAMPFIRE));
  public static Set<Material> CANDLES = new HashSet<>(List.of());
  public static Set<Material> FIRE =
      new HashSet<>(Arrays.asList(Material.FIRE, Material.SOUL_FIRE));
  public static Set<Material> LANTERNS =
      new HashSet<>(Arrays.asList(Material.LANTERN, Material.SOUL_LANTERN));
  public static Set<Material> SOUL_BLOCKS =
      new HashSet<>(Arrays.asList(Material.SOUL_SAND, Material.SOUL_SOIL));
  public static Set<Material> DIRECTIONAL_BLOCKS =
      new HashSet<>(
          Arrays.asList(
              ...
              Material.COMPARATOR));
  public static Set<Material> INTERACT_BLOCKS =
      new HashSet<>(
          Arrays.asList(
  ...
  public static Set<Material> SAFE_INTERACT_BLOCKS =
      new HashSet<>(
          Arrays.asList(
              Material.LEVER,
              Material.ACACIA_TRAPDOOR,
              ...
              Material.CRIMSON_TRAPDOOR,
              Material.WARPED_TRAPDOOR));
  public static Set<Material> UPDATE_STATE =
      new HashSet<>(
          Arrays.asList(
              Material.TORCH,
              Material.WALL_TORCH,
              ...
              Material.TARGET));
  public static Set<Material> NATURAL_BLOCKS =
      new HashSet<>(
          Arrays.asList(
              Material.STONE,
              Material.GOLD_ORE,
              ...
              Material.WITHER_ROSE,
              Material.SWEET_BERRY_BUSH));
  public static Set<Material> SCULK = new HashSet<>(List.of());

  /* blocks that support vertical scanning */
  public static Set<Material> VERTICAL_TOP_BOTTOM = new HashSet<>(List.of());
  public static Set<Material> VERTICAL_TOP = new HashSet<>(List.of());
  public static Set<Material> VERTICAL_BOTTOM = new HashSet<>(List.of());
  public static Set<Material> VERTICAL = new HashSet<>(List.of());

  // These are blocks that an item frame or painting can't be attached to.
  // Same as non_solid_entity_blocks? >>Perform testing<<
  public static Set<Material> NON_ATTACHABLE =
      new HashSet<>(
          Arrays.asList(
              Material.AIR,
              Material.CAVE_AIR,
