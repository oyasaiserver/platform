  ...
  protected static boolean patch(Statement statement) {
    try {
      if (Config.getGlobal().MYSQL) {
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN line_5 TEXT;");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN line_6 TEXT;");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN line_7 TEXT;");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN line_8 TEXT;");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
