  ...
  protected static boolean patch(Statement statement) {
    try {
      if (Config.getGlobal().MYSQL) {
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN data TINYINT");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
        ...
        try {
          statement.executeUpdate(
              "ALTER TABLE " + ConfigHandler.prefix + "sign ADD COLUMN data INTEGER;");
        } catch (Exception e) {
          Chat.console(
              Phrase.build(
                  Phrase.PATCH_SKIP_UPDATE,
