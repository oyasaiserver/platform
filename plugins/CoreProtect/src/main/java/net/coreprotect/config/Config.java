...
public class Config extends Language {
  ...
  static {
    ...
    HEADERS.put(
        "entity-kills", new String[] {"# Logs killed entities, such as killed cows and enderman."});
    HEADERS.put(
        "sign-text",
    ...
    HEADERS.put(
        "sculk-spread", new String[] {"# Logs the spread of sculk blocks from sculk catalysts."});
    HEADERS.put(
        "portals", new String[] {"# Logs when portals such as Nether portals generate naturally."});
    HEADERS.put(
        "water-flow",
        new String[] {
    ...
    HEADERS.put(
        "username-changes",
        new String[] {"# Logs when a player changes their Minecraft username."});
    HEADERS.put(
        "worldedit",
        new String[] {
  ...
  private static Map<String, byte[]> loadFiles(String fileName) throws IOException {
    ...
    for (final File worldConfigFile :
      ...
      map.put(
          ...
          Files.readAllBytes(worldConfigFile.toPath()));
    }
