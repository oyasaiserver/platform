...
/**
 * Bukkit adapter implementation for Minecraft 1.17. Provides version-specific implementations for
 * the BukkitInterface to handle features introduced in the 1.17 update.
 */
public class Bukkit_v1_17 extends BukkitAdapter {

  /**
   * Initializes the Bukkit_v1_17 adapter with 1.17-specific block groups. Sets up collections of
  ...
  /**
   * Initializes all the block groups for Minecraft 1.17. This includes new blocks like amethyst,
   * candles, pointed dripstone, etc.
   */
  private void initializeBlockGroups() {
    BlockGroup.TRACK_ANY =
        new HashSet<>(
            Arrays.asList(
    ...
    BlockGroup.TRACK_TOP_BOTTOM =
        new HashSet<>(Arrays.asList(Material.POINTED_DRIPSTONE, Material.BIG_DRIPLEAF_STEM));

    BlockGroup.TRACK_BOTTOM =
        new HashSet<>(
            Arrays.asList(
