...
/**
 * Bukkit adapter implementation for Minecraft 1.20. Provides version-specific implementations for
 * the BukkitInterface to handle features introduced in the 1.20 update, including: - Updated sign
 * handling with front/back sides - New block types (chiseled bookshelf, decorated pot) - Suspicious
 * blocks (sand/gravel) - Arrow potion handling
 */
public class Bukkit_v1_20 extends Bukkit_v1_19 {
  ...
  /**
   * Initializes the Bukkit_v1_20 adapter with 1.20-specific block groups and mappings. Sets up
