...
/**
 * Interface for Bukkit API compatibility across different Minecraft versions. Each method provides
 * version-specific implementations to handle differences between Minecraft/Bukkit API versions.
 */
public interface BukkitInterface {
   ...
   * @param scanBlock The block to check for attachment
   * @param blockData The block data
   * @param scanMin The minimum scan value
   ...
   *
   * @param material The bucket material
   ...
   *
   * @param material The plant material
   ...
   * @param list The list to populate with metadata
   * @param metadata The metadata list to populate
   * @param slot The slot
   ...
   *
   * @param rowType The material type
   * @param itemstack The item stack
  ...
  /**
   * Gets the wolf variant and adds it to the info list. Only implemented in Minecraft 1.21+.
   *
  ...
  /**
   * Sets the wolf variant from the provided value. Only implemented in Minecraft 1.21+.
   *
   * @param wolf The wolf entity
   ...
   *
   * @param sign The sign
   * @param isFront Whether to check the front side
   ...
   *
   * @param sign The sign
   * @param isFront Whether to set the front side
   * @param isGlowing Whether the sign should be glowing
   */
   ...
   *
   * @param sign The sign
   * @param isWaxed Whether the sign should be waxed
   */
   ...
   *
   * @param sign The sign
   * @param isFront Whether to get the front side color
