...
/**
 * Bukkit adapter implementation for Minecraft 1.18. Provides version-specific implementations for
 * the BukkitInterface to handle features introduced in the 1.18 update.
 */
public class Bukkit_v1_18 extends Bukkit_v1_17 {

  /**
   * Flag to track whether the MerchantRecipe.adjust() method is available. This is initialized on
   * first use and prevents repeated reflection checks. - null: Not yet checked - true: Method
   * exists and should be used - false: Method doesn't exist or failed, fallback to parent
   * implementation
   */
  private Boolean hasAdjustMethod = null;

  /**
   * Adjusts an ingredient in a merchant recipe for version 1.18+. This handles changes to the
   * MerchantRecipe API introduced in Bukkit 1.18.1.
   *
