...
/**
 * Base adapter implementation for Bukkit API compatibility. Provides default implementations for
 * methods that work across multiple Minecraft versions. Version-specific implementations extend
 * this class to provide specialized behavior.
 */
public class BukkitAdapter implements BukkitInterface {
  ...
  public boolean isAttached(Block block, Block scanBlock, BlockData blockData, int scanMin) {
    if (blockData instanceof Directional directional
        && blockData instanceof FaceAttachable faceAttachable) {
