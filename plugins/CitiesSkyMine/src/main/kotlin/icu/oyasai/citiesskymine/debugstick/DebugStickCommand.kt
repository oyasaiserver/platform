...
class DebugStickCommand(
    private val plugin: Main,
    memoryStore: DebugStickMemoryStore
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<String>): Boolean {
        ...
        if (plugin.config.getBoolean("debug-stick.require-creative", false) && sender.gameMode != GameMode.CREATIVE) {
