      ...
      "name" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId name <slot> <text>",
            ) ?: return
      ...
      "lore" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId lore <slot> <text>",
            ) ?: return
        val text = args.drop(4).joinToString(" ")
        if (text.isBlank()) {
      ...
      "clearlore" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId clearlore <slot>",
            ) ?: return
      ...
      "perm" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId perm <slot> [permission]",
            ) ?: return
      ...
      "action" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId action <slot> <type> [value]",
            ) ?: return
        val type =
      ...
      "clearactions" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId clearactions <slot>",
            ) ?: return
      ...
      "clearslot" -> {
        val slot =
            parseSlot(
                ...
                session,
                args.getOrNull(3),
                "&c使用方法: /.gm edit $menuId clearslot <slot>",
            ) ?: return
