...
class DebugStickService(private val plugin: Main, private val memoryStore: DebugStickMemoryStore) {
  ...
  fun cycle(player: Player): DebugStickResult {
    ...
    val nextData =
        propertyAccess.withPropertyValue(block.blockData, selected.name, nextValue)
