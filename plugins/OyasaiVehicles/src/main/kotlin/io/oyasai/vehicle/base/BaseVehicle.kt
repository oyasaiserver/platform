...
import org.bukkit.util.Vector
 ...
 abstract class BaseVehicle(
    ...
    protected fun calculateDescent(mainArmorStand: ArmorStand, descentValue: Double = GRAVITY_DESCENT): Double {
        val result =
            mainArmorStand.world.rayTraceBlocks(mainArmorStand.location, DOWN_VECTOR, RAYCAST_DISTANCE) ?: return descentValue
