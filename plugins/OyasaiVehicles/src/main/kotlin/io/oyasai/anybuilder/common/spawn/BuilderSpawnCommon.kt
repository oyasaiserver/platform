package io.oyasaiserver.anybuilder.common.spawn

import io.oyasaiserver.anybuilder.runtime.VehicleEntityData
...
object BuilderSpawnSupport {
    ...
    fun spawnSeat(
        ...
        for ((i, vec) in seatPairs) {
            ...
            val armorStand = world.spawnEntity(loc.clone().add(rotatedVec), EntityType.ARMOR_STAND) as ArmorStand
            armorStand.isSmall = true
            armorStand.isSilent = true
            armorStand.isInvisible = true
            armorStand.setGravity(false)
            ...
            armorStand.setItem(EquipmentSlot.HEAD, ItemStack(if (i == 0) Material.GREEN_WOOL else Material.BLACK_WOOL))
