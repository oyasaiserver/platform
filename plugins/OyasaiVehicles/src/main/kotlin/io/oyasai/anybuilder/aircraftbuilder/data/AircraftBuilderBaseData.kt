...
class AircraftBuilderConfig(fileName: String) : CustomYaml(fileName) {
  ...
  fun getOwnerUUID(): UUID? = io.oyasai.anybuilder.common.VehicleConfigCommon.getOwnerUUID(this)
  ...
  fun isOwnerOrAdmin(sender: CommandSender): Boolean =
      io.oyasai.anybuilder.common.VehicleConfigCommon.isOwnerOrAdmin(this, sender)
}
