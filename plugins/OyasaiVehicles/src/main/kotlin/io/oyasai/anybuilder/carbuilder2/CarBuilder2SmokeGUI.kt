...
object CarBuilder2SmokeGUI {
    private val colorMaterialList: Map<Material, Color> = mapOf(
    ...
    private val colorStringList: Map<Material, String> = mapOf(
    ...
    fun smokeGUI(): OyasaiMenu {
        ...
        gui.setGlobalClickAction { event: org.bukkit.event.inventory.InventoryClickEvent -> event.isCancelled = true }
        gui.setGlobalDragAction { event: org.bukkit.event.inventory.InventoryDragEvent -> event.isCancelled = true }
