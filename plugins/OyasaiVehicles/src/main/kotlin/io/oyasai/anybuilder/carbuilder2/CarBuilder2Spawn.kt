...
import io.oyasai.anybuilder.common.BuilderSpawnSupport
  ...
  fun spawn(
    ...
    val seatMap =
        BuilderSpawnSupport.spawnSeat(
            loc,
            data.config.getSeatList().entries.map { it.key to it.value },
            yaw,
            indexedName = false)
    ...
    CarBuilder2EntityList.addCarEntity(cEntity)
