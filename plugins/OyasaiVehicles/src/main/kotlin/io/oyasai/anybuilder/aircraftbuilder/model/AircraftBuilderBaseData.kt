...
class AircraftBuilderConfig(fileName: String) : CustomYaml(fileName) {
    ...
    fun isOwnerOrAdmin(sender: CommandSender): Boolean = VehicleConfigCommon.isOwnerOrAdmin(this, sender)
}

class AircraftBuilderBaseData(name: String) : BaseVehicleBaseDataCore<AircraftBuilderConfig>(
    name,
...
object AircraftBuilderBaseCache : BaseVehicleCache<AircraftBuilderBaseData>("AircraftBuilder", "AircraftBuilder") {
