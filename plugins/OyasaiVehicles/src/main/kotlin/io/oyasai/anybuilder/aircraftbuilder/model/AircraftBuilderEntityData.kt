...
import io.oyasai.anybuilder.aircraftbuilder.controller.startImpl
import io.oyasai.anybuilder.aircraftbuilder.layout.reOffsetDisplayImpl
import io.oyasai.anybuilder.aircraftbuilder.layout.saveDefImpl
import io.oyasai.anybuilder.aircraftbuilder.lifecycle.autoSitStartImpl
import io.oyasai.anybuilder.aircraftbuilder.lifecycle.exitTaskImpl
import io.oyasai.anybuilder.aircraftbuilder.presentation.bodyLightTaskImpl
import io.oyasai.anybuilder.aircraftbuilder.presentation.setDisplayRotateImpl
import io.oyasai.anybuilder.aircraftbuilder.presentation.soundTaskImpl
import io.oyasai.anybuilder.aircraftbuilder.presentation.updateBarImpl
...
data class AircraftBuilderEntityData(
  ...
  override fun displayGroups(): Iterable<Iterable<Display>> = this.display.values
