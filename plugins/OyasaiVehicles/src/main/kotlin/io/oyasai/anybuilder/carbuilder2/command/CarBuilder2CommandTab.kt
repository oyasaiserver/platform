...
// carbuilder2|cbmenu tab completion for: <name> spawn|buy|info|save|size|offset|headlight|sound|spring|machineset|eventcar
...
fun handleCarBuilder2Tab(
    ...
    return when (args.size) {
        ...
        2 -> {
            val data = CarBuilder2BaseCache.getBaseData(args[0]) ?: return if (sender.canCreateCarBuilder2()) mutableListOf(
                "save"
            ) else mutableListOf()
            ...
            if (sender.canManageCarBuilder2(data)) {
                subCommands.addAll(listOf("save", "size", "offset", "headlight", "sound", "spring", "delete"))
            }
        ...
        3 -> {
            ...
            when (sub) {
                ...
                "save", "size" -> tabFilter(current, listOf("body", "wheel", "wheel2", "headlight"))
                else -> mutableListOf()
            }
        }
        4 -> {
            ...
            when (sub) {
                "machineset" -> tabFilter(current, listOf("<パワー(1～1000)>", "64", "180", "280", "320", "500", "700", "1000"))
        ...
        5 -> {
            ...
            when (sub) {
                "machineset" -> tabFilter(current, listOf("<ブレーキ(1～1000)>", "128", "200", "350", "425", "500", "600", "800", "1000"))
        ...
        6 -> {
            ...
            when (sub) {
                "machineset" -> tabFilter(current, listOf("<ギア数(1～100)>", "1", "2", "3", "4", "5", "6", "7", "8"))
