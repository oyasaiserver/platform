package io.oyasaiserver.anybuilder.common.command

import io.oyasaiserver.anybuilder.runtime.BaseVehicleCache
import io.oyasaiserver.anybuilder.runtime.BaseVehicleEntityList
...
object BuilderLifecycle {
    fun register(
        ...
        VehicleRegistry.register(entityList, cache)
        cache.reloadCache()
    }
}
...
object BuilderCommandTabSupport {
    private fun filterBy(
        ...
        return values.filter { value ->
            predicate(value.lowercase(Locale.ROOT), c)
        }.toMutableList()
    }
