 ...
 *
 * YAML 構造: blocks: name: '&1ブロック' rows: 6 # InventoryShop互換フィールド (読み込むが使わない) command: 'blocks' #
 * オプション: ショートカットコマンド名 items:
...
data class ShopCategory(
  ...
  /** 1ページに表示するアイテム数は45スロット固定 (インベントリ6行 - 下段1行 = 5行 × 9列) */
...
/** プレイヤーがショップを開いているときの状態。 プレイヤーUUID をキーとして ShopEngine 内で管理する。 */
