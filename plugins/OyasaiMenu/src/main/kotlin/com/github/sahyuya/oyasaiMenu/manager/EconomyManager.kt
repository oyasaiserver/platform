 ...
 *
 * Vault Economy API のシングルトンラッパー。 Vault / 経済プラグイン未導入でも NullPointerException が発生しない。
 */
object EconomyManager {
  ...
  fun deposit(player: Player, amount: Double): String? {
    ...
    val eco = economy ?: return "&c経済プラグインが見つかりません。"
    return if (eco.depositPlayer(player, amount).transactionSuccess()) null else "&c入金処理に失敗しました。"
  }
