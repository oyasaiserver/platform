 ...
 *
 * 使い方: CustomHead.get("c7da319bc006a570c550846c0e8cf6ad88d326ec9f447d5c168228c4d2dd6e27")
 *
 * texture はMinecraftのテクスチャハッシュ文字列 (64文字の16進数)。 これはスキンURLの末尾部分:
 * https://textures.minecraft.net/texture/<hash>
 *
 * Paper API の com.destroystokyo.paper.profile.PlayerProfile を使用。 pom.xml に paper-api (provided)
 * が宣言されていれば追加依存なし。
 */
object CustomHead {
  ...
  fun get(textureHash: String): ItemStack {
    ...
    val textureJson =
        """{"textures":{"SKIN":{"url":"https://textures.minecraft.net/texture/$textureHash"}}}"""
