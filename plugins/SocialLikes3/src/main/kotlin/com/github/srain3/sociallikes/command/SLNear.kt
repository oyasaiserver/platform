...
object SLNear: CommandExecutor {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        for (i in 0 until size) {
            ...
            sender.spigot().sendMessage(TextComponent(Tools.socialLikesLOGO + "&r${distance}m先: &a${data.title}&7(ID:${data.id})".color()).apply {
                this.clickEvent = ClickEvent(ClickEvent.Action.RUN_COMMAND, "/sociallikes3:sltp ${data.id}")
