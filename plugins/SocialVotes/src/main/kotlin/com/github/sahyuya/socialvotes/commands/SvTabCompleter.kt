...
class SvTabCompleter : TabCompleter {
  ...
  private val baseCommands = listOf("setgroup", "add", "list", "help")

  private val ownerCommands = listOf("remove", "startvote", "stopvote")
  ...
  override fun onTabComplete(
    ...
    if (args.size == 2 && sender is Player) {
      ...
      val allowedGroups = GroupPermissionUtil.ownedGroups(sender, dm.groupByName.values)
