...
object PackControlCodec {
  ...
  fun encode(message: Message): ByteArray {
    ...
    return ByteBuffer.allocate(SIZE)
        .apply {
          put(1.toByte())
          put(message.operation.toByte())
          putLong(message.requestId.mostSignificantBits)
          putLong(message.requestId.leastSignificantBits)
          putLong(message.targetId.mostSignificantBits)
          putLong(message.targetId.leastSignificantBits)
        }
        .array()
  }
