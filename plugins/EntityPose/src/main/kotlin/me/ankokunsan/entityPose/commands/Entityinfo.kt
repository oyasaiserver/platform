...
class Entityinfo : CommandExecutor, TabCompleter{
    override fun onCommand(
        ...
        val result = sender.world.rayTraceEntities(sender.eyeLocation, sender.location.direction, 3.0, 0.5) { it != sender }
        val target = result?.hitEntity ?: return true.also { sender.sendMessage("§6[EntityPose] §cエンティティがいません") }
