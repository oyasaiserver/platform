...
*/
export declare class DataGithubOrganizationCustomRole extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_organization_custom_role";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataGithubOrganizationCustomRoleConfig);
    get baseRole(): any;
    get description(): any;
    private _id?;
    get id(): string;
