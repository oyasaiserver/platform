...
export function enterpriseActionsPermissionsAllowedActionsConfigToTerraform(struct) {
...
export function enterpriseActionsPermissionsAllowedActionsConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function enterpriseActionsPermissionsEnabledOrganizationsConfigToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function enterpriseActionsPermissionsEnabledOrganizationsConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class EnterpriseActionsPermissions extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_enterprise_actions_permissions";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _allowedActionsConfig = new EnterpriseActionsPermissionsAllowedActionsConfigOutputReference(this, "allowed_actions_config");
    ...
    _enabledOrganizationsConfig = new EnterpriseActionsPermissionsEnabledOrganizationsConfigOutputReference(this, "enabled_organizations_config");
    get enabledOrganizationsConfig() {
        return this._enabledOrganizationsConfig;
    }
    putEnabledOrganizationsConfig(value) {
    ...
    // Temporarily expose input value. Use with caution.
    get enabledOrganizationsConfigInput() {
