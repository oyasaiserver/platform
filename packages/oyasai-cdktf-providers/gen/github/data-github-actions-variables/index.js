...
export function dataGithubActionsVariablesVariablesToTerraform(struct) {
...
export function dataGithubActionsVariablesVariablesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubActionsVariables extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_actions_variables";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _variables = new DataGithubActionsVariablesVariablesList(this, "variables", false);
    get variables() {
