...
export function dataGithubActionsOrganizationSecretsSecretsToTerraform(struct) {
...
export function dataGithubActionsOrganizationSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubActionsOrganizationSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_actions_organization_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubActionsOrganizationSecretsSecretsList(this, "secrets", false);
    get secrets() {
