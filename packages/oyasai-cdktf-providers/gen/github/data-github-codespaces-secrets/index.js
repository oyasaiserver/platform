...
export function dataGithubCodespacesSecretsSecretsToTerraform(struct) {
...
export function dataGithubCodespacesSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubCodespacesSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_codespaces_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubCodespacesSecretsSecretsList(this, "secrets", false);
    get secrets() {
