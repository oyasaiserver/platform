...
export declare function dataGithubCodespacesSecretsSecretsToTerraform(struct?: DataGithubCodespacesSecretsSecrets): any;
export declare function dataGithubCodespacesSecretsSecretsToHclTerraform(struct?: DataGithubCodespacesSecretsSecrets): any;
export declare class DataGithubCodespacesSecretsSecretsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataGithubCodespacesSecretsSecrets | undefined;
    set internalValue(value: DataGithubCodespacesSecretsSecrets | undefined);
    get createdAt(): any;
    get name(): any;
    get updatedAt(): any;
}
export declare class DataGithubCodespacesSecretsSecretsList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataGithubCodespacesSecretsSecretsOutputReference;
}
/**
...
*/
export declare class DataGithubCodespacesSecrets extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_codespaces_secrets";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubCodespacesSecretsConfig);
    private _fullName?;
    get fullName(): string;
    ...
    private _secrets;
    get secrets(): DataGithubCodespacesSecretsSecretsList;
