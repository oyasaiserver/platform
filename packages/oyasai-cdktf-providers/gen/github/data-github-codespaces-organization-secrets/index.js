...
export function dataGithubCodespacesOrganizationSecretsSecretsToTerraform(struct) {
...
export function dataGithubCodespacesOrganizationSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubCodespacesOrganizationSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_codespaces_organization_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubCodespacesOrganizationSecretsSecretsList(this, "secrets", false);
    get secrets() {
