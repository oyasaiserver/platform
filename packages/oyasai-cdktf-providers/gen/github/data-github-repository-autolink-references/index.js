...
export function dataGithubRepositoryAutolinkReferencesAutolinkReferencesToTerraform(struct) {
...
export function dataGithubRepositoryAutolinkReferencesAutolinkReferencesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubRepositoryAutolinkReferences extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_repository_autolink_references";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _autolinkReferences = new DataGithubRepositoryAutolinkReferencesAutolinkReferencesList(this, "autolink_references", false);
    get autolinkReferences() {
