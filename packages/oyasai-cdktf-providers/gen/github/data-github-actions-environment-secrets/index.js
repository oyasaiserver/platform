...
export function dataGithubActionsEnvironmentSecretsSecretsToTerraform(struct) {
...
export function dataGithubActionsEnvironmentSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubActionsEnvironmentSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_actions_environment_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubActionsEnvironmentSecretsSecretsList(this, "secrets", false);
    get secrets() {
