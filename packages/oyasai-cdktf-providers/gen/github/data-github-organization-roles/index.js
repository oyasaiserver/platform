...
export function dataGithubOrganizationRolesRolesToTerraform(struct) {
...
export function dataGithubOrganizationRolesRolesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubOrganizationRoles extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_organization_roles";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _roles = new DataGithubOrganizationRolesRolesList(this, "roles", false);
    get roles() {
        return this._roles;
    }
    // =========
