...
*/
export declare class ActionsVariable extends cdktf.TerraformResource {
    static readonly tfResourceType = "github_actions_variable";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: ActionsVariableConfig);
    get createdAt(): any;
    private _id?;
    get id(): string;
    set id(value: string);
