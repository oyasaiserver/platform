...
*/
export declare class DataGithubCodespacesOrganizationPublicKey extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_codespaces_organization_public_key";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubCodespacesOrganizationPublicKeyConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
