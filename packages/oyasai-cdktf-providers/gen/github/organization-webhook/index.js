...
export function organizationWebhookConfigurationToTerraform(struct) {
...
export function organizationWebhookConfigurationToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class OrganizationWebhook extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_organization_webhook";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _configuration = new OrganizationWebhookConfigurationOutputReference(this, "configuration");
    get configuration() {
