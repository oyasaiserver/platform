...
export declare function dataGithubActionsOrganizationVariablesVariablesToTerraform(struct?: DataGithubActionsOrganizationVariablesVariables): any;
export declare function dataGithubActionsOrganizationVariablesVariablesToHclTerraform(struct?: DataGithubActionsOrganizationVariablesVariables): any;
export declare class DataGithubActionsOrganizationVariablesVariablesOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataGithubActionsOrganizationVariablesVariables | undefined;
    set internalValue(value: DataGithubActionsOrganizationVariablesVariables | undefined);
    get createdAt(): any;
    get name(): any;
    get updatedAt(): any;
    get value(): any;
...
export declare class DataGithubActionsOrganizationVariablesVariablesList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataGithubActionsOrganizationVariablesVariablesOutputReference;
}
/**
...
*/
export declare class DataGithubActionsOrganizationVariables extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_actions_organization_variables";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubActionsOrganizationVariablesConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
    get idInput(): string;
    private _variables;
    get variables(): DataGithubActionsOrganizationVariablesVariablesList;
