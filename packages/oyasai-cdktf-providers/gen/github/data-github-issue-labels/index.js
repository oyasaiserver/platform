...
export function dataGithubIssueLabelsLabelsToTerraform(struct) {
...
export function dataGithubIssueLabelsLabelsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubIssueLabels extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _labels = new DataGithubIssueLabelsLabelsList(this, "labels", false);
    get labels() {
        return this._labels;
    }
