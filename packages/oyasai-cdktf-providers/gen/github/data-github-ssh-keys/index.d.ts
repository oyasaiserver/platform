...
*/
export declare class DataGithubSshKeys extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_ssh_keys";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubSshKeysConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
