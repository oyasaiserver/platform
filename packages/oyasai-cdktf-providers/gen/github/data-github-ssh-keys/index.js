...
exports.DataGithubSshKeys = void 0;
...
*/
var DataGithubSshKeys = /** @class */ (function (_super) {
    __extends(DataGithubSshKeys, _super);
    // ===========
    // INITIALIZER
    // ===========
    /**
    ...
    */
    function DataGithubSshKeys(scope, id, config) {
    ...
    */
    DataGithubSshKeys.generateConfigForImport = function (scope, importToId, importFromId, provider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "github_ssh_keys", importId: importFromId, provider: provider });
    };
    Object.defineProperty(DataGithubSshKeys.prototype, "id", {
        get: function () {
    ...
    DataGithubSshKeys.prototype.resetId = function () {
        this._id = undefined;
    };
    Object.defineProperty(DataGithubSshKeys.prototype, "idInput", {
    ...
    Object.defineProperty(DataGithubSshKeys.prototype, "keys", {
    ...
    // SYNTHESIS
    // =========
    DataGithubSshKeys.prototype.synthesizeAttributes = function () {
        return {
            id: cdktf.stringToTerraform(this._id),
        };
    };
    DataGithubSshKeys.prototype.synthesizeHclAttributes = function () {
        var attrs = {
            id: {
    ...
    // STATIC PROPERTIES
    // =================
    DataGithubSshKeys.tfResourceType = "github_ssh_keys";
    return DataGithubSshKeys;
}(cdktf.TerraformDataSource));
exports.DataGithubSshKeys = DataGithubSshKeys;
