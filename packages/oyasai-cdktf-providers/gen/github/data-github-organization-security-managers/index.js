...
export function dataGithubOrganizationSecurityManagersTeamsToTerraform(struct) {
...
export function dataGithubOrganizationSecurityManagersTeamsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubOrganizationSecurityManagers extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_organization_security_managers";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _teams = new DataGithubOrganizationSecurityManagersTeamsList(this, "teams", false);
    get teams() {
        return this._teams;
    }
    // =========
