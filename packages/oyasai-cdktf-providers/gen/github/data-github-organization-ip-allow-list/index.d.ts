...
export declare function dataGithubOrganizationIpAllowListIpAllowListStructToTerraform(struct?: DataGithubOrganizationIpAllowListIpAllowListStruct): any;
export declare function dataGithubOrganizationIpAllowListIpAllowListStructToHclTerraform(struct?: DataGithubOrganizationIpAllowListIpAllowListStruct): any;
export declare class DataGithubOrganizationIpAllowListIpAllowListStructOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataGithubOrganizationIpAllowListIpAllowListStruct | undefined;
    set internalValue(value: DataGithubOrganizationIpAllowListIpAllowListStruct | undefined);
    get allowListValue(): any;
    get createdAt(): any;
    get id(): any;
    get isActive(): any;
    get name(): any;
...
export declare class DataGithubOrganizationIpAllowListIpAllowListStructList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataGithubOrganizationIpAllowListIpAllowListStructOutputReference;
}
/**
...
*/
export declare class DataGithubOrganizationIpAllowList extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_organization_ip_allow_list";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubOrganizationIpAllowListConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
    ...
    get ipAllowList(): DataGithubOrganizationIpAllowListIpAllowListStructList;
