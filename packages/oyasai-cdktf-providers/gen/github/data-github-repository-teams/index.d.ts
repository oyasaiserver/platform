...
export declare function dataGithubRepositoryTeamsTeamsToTerraform(struct?: DataGithubRepositoryTeamsTeams): any;
export declare function dataGithubRepositoryTeamsTeamsToHclTerraform(struct?: DataGithubRepositoryTeamsTeams): any;
export declare class DataGithubRepositoryTeamsTeamsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataGithubRepositoryTeamsTeams | undefined;
    set internalValue(value: DataGithubRepositoryTeamsTeams | undefined);
    get name(): any;
    get permission(): any;
    get slug(): any;
}
export declare class DataGithubRepositoryTeamsTeamsList extends cdktf.ComplexList {
...
*/
export declare class DataGithubRepositoryTeams extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "github_repository_teams";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGithubRepositoryTeamsConfig);
    private _fullName?;
    get fullName(): string;
    ...
    private _teams;
    get teams(): DataGithubRepositoryTeamsTeamsList;
