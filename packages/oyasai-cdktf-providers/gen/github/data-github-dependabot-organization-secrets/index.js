...
export function dataGithubDependabotOrganizationSecretsSecretsToTerraform(struct) {
...
export function dataGithubDependabotOrganizationSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubDependabotOrganizationSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_dependabot_organization_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubDependabotOrganizationSecretsSecretsList(this, "secrets", false);
    get secrets() {
