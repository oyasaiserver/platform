...
export function dataGithubRepositoryEnvironmentsEnvironmentsToTerraform(struct) {
...
export function dataGithubRepositoryEnvironmentsEnvironmentsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubRepositoryEnvironments extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_repository_environments";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _environments = new DataGithubRepositoryEnvironmentsEnvironmentsList(this, "environments", false);
    get environments() {
