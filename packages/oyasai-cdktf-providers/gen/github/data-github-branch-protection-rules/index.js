...
export function dataGithubBranchProtectionRulesRulesToTerraform(struct) {
...
export function dataGithubBranchProtectionRulesRulesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubBranchProtectionRules extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_branch_protection_rules";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _rules = new DataGithubBranchProtectionRulesRulesList(this, "rules", false);
    get rules() {
        return this._rules;
    }
    // =========
