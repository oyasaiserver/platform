...
*/
var EnterpriseActionsWorkflowPermissions = /** @class */ (function (_super) {
    __extends(EnterpriseActionsWorkflowPermissions, _super);
    // ===========
    // INITIALIZER
    // ===========
    /**
    ...
    */
    function EnterpriseActionsWorkflowPermissions(scope, id, config) {
    ...
    */
    EnterpriseActionsWorkflowPermissions.generateConfigForImport = function (scope, importToId, importFromId, provider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "github_enterprise_actions_workflow_permissions", importId: importFromId, provider: provider });
    };
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "canApprovePullRequestReviews", {
        get: function () {
    ...
    EnterpriseActionsWorkflowPermissions.prototype.resetCanApprovePullRequestReviews = function () {
        this._canApprovePullRequestReviews = undefined;
    };
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "canApprovePullRequestReviewsInput", {
    ...
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "defaultWorkflowPermissions", {
        get: function () {
    ...
    EnterpriseActionsWorkflowPermissions.prototype.resetDefaultWorkflowPermissions = function () {
        this._defaultWorkflowPermissions = undefined;
    };
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "defaultWorkflowPermissionsInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
    ...
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "enterpriseSlug", {
        get: function () {
    ...
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "enterpriseSlugInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
    ...
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "id", {
        get: function () {
    ...
    EnterpriseActionsWorkflowPermissions.prototype.resetId = function () {
        this._id = undefined;
    };
    Object.defineProperty(EnterpriseActionsWorkflowPermissions.prototype, "idInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
            return this._id;
        },
    ...
    // SYNTHESIS
    // =========
    EnterpriseActionsWorkflowPermissions.prototype.synthesizeAttributes = function () {
        return {
    ...
    EnterpriseActionsWorkflowPermissions.prototype.synthesizeHclAttributes = function () {
        var attrs = {
    ...
    // STATIC PROPERTIES
    // =================
    EnterpriseActionsWorkflowPermissions.tfResourceType = "github_enterprise_actions_workflow_permissions";
    return EnterpriseActionsWorkflowPermissions;
