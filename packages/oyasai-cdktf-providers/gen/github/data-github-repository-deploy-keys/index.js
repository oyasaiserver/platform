...
export function dataGithubRepositoryDeployKeysKeysToTerraform(struct) {
...
export function dataGithubRepositoryDeployKeysKeysToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubRepositoryDeployKeys extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_repository_deploy_keys";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _keys = new DataGithubRepositoryDeployKeysKeysList(this, "keys", false);
    get keys() {
        return this._keys;
    }
