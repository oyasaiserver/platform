...
export function dataGithubCodespacesUserSecretsSecretsToTerraform(struct) {
...
export function dataGithubCodespacesUserSecretsSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataGithubCodespacesUserSecrets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "github_codespaces_user_secrets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _secrets = new DataGithubCodespacesUserSecretsSecretsList(this, "secrets", false);
    get secrets() {
