...
export function imageBuildAuthConfigToTerraform(struct) {
...
export function imageBuildAuthConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildSecretsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildSecretsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildUlimitToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildUlimitToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageBuildToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class ImageBuildOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _authConfig = new ImageBuildAuthConfigList(this, "auth_config", false);
    get authConfig() {
    ...
    _secrets = new ImageBuildSecretsList(this, "secrets", false);
    get secrets() {
    ...
    _ulimit = new ImageBuildUlimitList(this, "ulimit", false);
    get ulimit() {
        return this._ulimit;
    }
    putUlimit(value) {
...
export function imageTimeoutsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function imageTimeoutsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class Image extends cdktf.TerraformResource {
    ...
    */
    ...
    _build = new ImageBuildOutputReference(this, "build");
    get buildAttribute() {
        return this._build;
    }
    ...
    _timeouts = new ImageTimeoutsOutputReference(this, "timeouts");
    get timeouts() {
