// https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume
...
export interface VolumeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#driver Volume#driver}
  */
  readonly driver?: string;
  /**
  * Options specific to the driver.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#driver_opts Volume#driver_opts}
  */
  readonly driverOpts?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#id Volume#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#name Volume#name}
  */
  readonly name?: string;
  /**
  * cluster block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#cluster Volume#cluster}
  */
  readonly cluster?: VolumeCluster;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#labels Volume#labels}
  */
...
export interface VolumeCluster {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#availability Volume#availability}
  */
  readonly availability?: string;
  /**
  * Cluster Volume group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#group Volume#group}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#limit_bytes Volume#limit_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#required_bytes Volume#required_bytes}
  */
  readonly requiredBytes?: string;
  /**
  * The scope of the volume. Can be `single` (default) or `multi`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#scope Volume#scope}
  */
  readonly scope?: string;
  /**
  * The sharing mode. Can be `none` (default), `readonly`, `onewriter` or `all`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#sharing Volume#sharing}
  */
  readonly sharing?: string;
  /**
  * A topology that the Cluster Volume would be preferred in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#topology_preferred Volume#topology_preferred}
  */
  readonly topologyPreferred?: string;
  /**
  * A topology that the Cluster Volume must be accessible from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#topology_required Volume#topology_required}
  */
  readonly topologyRequired?: string;
  /**
  * Cluster Volume access type. Can be `mount` or `block` (default).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#type Volume#type}
  */
...
export interface VolumeLabels {
  ...
  * Name of the label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#label Volume#label}
  */
  readonly label: string;
  /**
  * Value of the label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#value Volume#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume docker_volume}
*/
export class Volume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Volume that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.1.0/docs/resources/volume docker_volume} Resource
  *
  * @param scope The scope in which to define this construct
