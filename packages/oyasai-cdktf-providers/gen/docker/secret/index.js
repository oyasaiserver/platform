...
export function secretLabelsToTerraform(struct) {
...
export function secretLabelsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class Secret extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "docker_secret";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _labels = new SecretLabelsList(this, "labels", true);
    get labels() {
        return this._labels;
    }
    putLabels(value) {
