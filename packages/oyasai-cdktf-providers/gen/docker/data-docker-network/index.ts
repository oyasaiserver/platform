// https://registry.terraform.io/providers/kreuzwerker/docker/4.0.0/docs/data-sources/network
...
export interface DataDockerNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.0.0/docs/data-sources/network#name DataDockerNetwork#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.0.0/docs/data-sources/network docker_network}
*/
export class DataDockerNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDockerNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.0.0/docs/data-sources/network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.0.0/docs/data-sources/network docker_network} Data Source
  *
  * @param scope The scope in which to define this construct
