...
export class Container extends cdktf.TerraformResource {
  ...
  */
  ...
  public get deviceCgroupRules() {
    return cdktf.Fn.tolist(this.getListAttribute('device_cgroup_rules'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      device_cgroup_rules: cdktf.listMapper(cdktf.stringToTerraform, false)(this._deviceCgroupRules),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      device_cgroup_rules: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._deviceCgroupRules),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
