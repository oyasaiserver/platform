...
export function appConnectionAzureKeyVaultCredentialsToTerraform(struct) {
...
export function appConnectionAzureKeyVaultCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AppConnectionAzureKeyVault extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_app_connection_azure_key_vault";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _credentials = new AppConnectionAzureKeyVaultCredentialsOutputReference(this, "credentials");
    get credentials() {
