// https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault
...
export interface AppConnectionAzureKeyVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#credentials AppConnectionAzureKeyVault#credentials}
  */
  readonly credentials: AppConnectionAzureKeyVaultCredentials;
  /**
  * An optional description for the Azure Key Vault App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#description AppConnectionAzureKeyVault#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Azure Key Vault. Possible values are: client-secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#method AppConnectionAzureKeyVault#method}
  */
  readonly method: string;
  /**
  * The name of the Azure Key Vault App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#name AppConnectionAzureKeyVault#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#project_id AppConnectionAzureKeyVault#project_id}
  */
...
export interface AppConnectionAzureKeyVaultCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#client_id AppConnectionAzureKeyVault#client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#client_secret AppConnectionAzureKeyVault#client_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#tenant_id AppConnectionAzureKeyVault#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault infisical_app_connection_azure_key_vault}
*/
export class AppConnectionAzureKeyVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionAzureKeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/app_connection_azure_key_vault infisical_app_connection_azure_key_vault} Resource
  *
  * @param scope The scope in which to define this construct
