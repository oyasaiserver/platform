// https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog
...
export interface AppConnectionDatadogConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#credentials AppConnectionDatadog#credentials}
  */
  readonly credentials: AppConnectionDatadogCredentials;
  /**
  * An optional description for the Datadog App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#description AppConnectionDatadog#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Datadog. Possible values are: api-key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#method AppConnectionDatadog#method}
  */
  readonly method: string;
  /**
  * The name of the Datadog App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#name AppConnectionDatadog#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#project_id AppConnectionDatadog#project_id}
  */
...
export interface AppConnectionDatadogCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#api_key AppConnectionDatadog#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#application_key AppConnectionDatadog#application_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#url AppConnectionDatadog#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog infisical_app_connection_datadog}
*/
export class AppConnectionDatadog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionDatadog that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/app_connection_datadog infisical_app_connection_datadog} Resource
  *
  * @param scope The scope in which to define this construct
