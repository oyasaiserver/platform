// https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate
...
export interface CertManagerCaCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#ca_id CertManagerCaCertificate#ca_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#max_path_length CertManagerCaCertificate#max_path_length}
  */
  readonly maxPathLength?: number;
  /**
  * The date and time when the CA expires in RFC3339 format (e.g., '2034-01-01T00:00:00Z')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#not_after CertManagerCaCertificate#not_after}
  */
  readonly notAfter: string;
  /**
  * The date and time when the CA becomes valid in RFC3339 format (e.g., '2024-01-01T00:00:00Z')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#not_before CertManagerCaCertificate#not_before}
  */
  readonly notBefore: string;
  /**
  * The ID of the parent CA (required for intermediate CAs)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#parent_ca_id CertManagerCaCertificate#parent_ca_id}
  */
  readonly parentCaId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate infisical_cert_manager_ca_certificate}
*/
export class CertManagerCaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerCaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_ca_certificate infisical_cert_manager_ca_certificate} Resource
  *
  * @param scope The scope in which to define this construct
