// https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity
...
export interface CertManagerIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity#identity_id CertManagerIdentity#identity_id}
  */
  readonly identityId: string;
  /**
  * The role to assign to the identity (admin or member)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity#role CertManagerIdentity#role}
  */
  readonly role: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity infisical_cert_manager_identity}
*/
export class CertManagerIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/cert_manager_identity infisical_cert_manager_identity} Resource
  *
  * @param scope The scope in which to define this construct
