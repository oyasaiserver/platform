...
export function appConnectionAzureAppConfigurationCredentialsToTerraform(struct) {
...
export function appConnectionAzureAppConfigurationCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AppConnectionAzureAppConfiguration extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_app_connection_azure_app_configuration";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _credentials = new AppConnectionAzureAppConfigurationCredentialsOutputReference(this, "credentials");
    get credentials() {
