// https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret
...
export interface SecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#env_slug Secret#env_slug}
  */
  readonly envSlug: string;
  /**
  * The path to the folder where the given secret resides
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#folder_path Secret#folder_path}
  */
  readonly folderPath: string;
  /**
  * Metadata associated with the secret as key-value pairs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#metadata Secret#metadata}
  */
  readonly metadata?: { [key: string]: string };
  /**
  * The name of the secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#name Secret#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#secret_reminder Secret#secret_reminder}
  */
  readonly secretReminder?: SecretSecretReminder;
  /**
  * Tag ids to be attached for the secrets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#tag_ids Secret#tag_ids}
  */
  readonly tagIds?: string[];
  /**
  * The value of the secret in plain text. This is required if `value_wo` is not set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#value Secret#value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#value_wo Secret#value_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#value_wo_version Secret#value_wo_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#workspace_id Secret#workspace_id}
  */
...
export interface SecretSecretReminder {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#note Secret#note}
  */
  readonly note?: string;
  /**
  * Frequency of secret rotation reminder in days
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#repeat_days Secret#repeat_days}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret infisical_secret}
*/
export class Secret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Secret that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/secret infisical_secret} Resource
  *
  * @param scope The scope in which to define this construct
