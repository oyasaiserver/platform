// https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity
...
export interface DataInfisicalProjectIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity#identity_id DataInfisicalProjectIdentity#identity_id}
  */
  readonly identityId: string;
  /**
  * The ID of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity#project_id DataInfisicalProjectIdentity#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity infisical_project_identity}
*/
export class DataInfisicalProjectIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalProjectIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/project_identity infisical_project_identity} Data Source
  *
  * @param scope The scope in which to define this construct
