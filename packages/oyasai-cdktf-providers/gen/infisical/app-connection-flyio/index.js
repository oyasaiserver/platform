...
export function appConnectionFlyioCredentialsToTerraform(struct) {
...
export function appConnectionFlyioCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AppConnectionFlyio extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_app_connection_flyio";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _credentials = new AppConnectionFlyioCredentialsOutputReference(this, "credentials");
    get credentials() {
