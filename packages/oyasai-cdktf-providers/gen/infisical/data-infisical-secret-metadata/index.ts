// https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata
...
export interface DataInfisicalSecretMetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#environment_slug DataInfisicalSecretMetadata#environment_slug}
  */
  readonly environmentSlug: string;
  /**
  * The path to the folder where the secret is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#folder_path DataInfisicalSecretMetadata#folder_path}
  */
  readonly folderPath: string;
  /**
  * The name of the secret to retrieve properties for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#name DataInfisicalSecretMetadata#name}
  */
  readonly name: string;
  /**
  * The Infisical project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#project_id DataInfisicalSecretMetadata#project_id}
  */
  readonly projectId: string;
  /**
  * The type of the secret (shared or personal). Defaults to shared.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#secret_type DataInfisicalSecretMetadata#secret_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata infisical_secret_metadata}
*/
export class DataInfisicalSecretMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalSecretMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.26/docs/data-sources/secret_metadata infisical_secret_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
