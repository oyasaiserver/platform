...
export function secretRotationMysqlCredentialsParametersToTerraform(struct) {
...
export function secretRotationMysqlCredentialsParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsRotateAtUtcToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsRotateAtUtcToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsSecretsMappingToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsSecretsMappingToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsTemporaryParametersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMysqlCredentialsTemporaryParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretRotationMysqlCredentials extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_rotation_mysql_credentials";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _parameters = new SecretRotationMysqlCredentialsParametersOutputReference(this, "parameters");
    get parameters() {
    ...
    _rotateAtUtc = new SecretRotationMysqlCredentialsRotateAtUtcOutputReference(this, "rotate_at_utc");
    get rotateAtUtc() {
    ...
    _secretsMapping = new SecretRotationMysqlCredentialsSecretsMappingOutputReference(this, "secrets_mapping");
    get secretsMapping() {
    ...
    _temporaryParameters = new SecretRotationMysqlCredentialsTemporaryParametersOutputReference(this, "temporary_parameters");
