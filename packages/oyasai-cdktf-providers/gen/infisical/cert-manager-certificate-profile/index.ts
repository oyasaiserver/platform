// https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile
...
export interface CertManagerCertificateProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#ca_id CertManagerCertificateProfile#ca_id}
  */
  readonly caId?: string;
  /**
  * The ID of the certificate policy to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#certificate_policy_id CertManagerCertificateProfile#certificate_policy_id}
  */
  readonly certificatePolicyId: string;
  /**
  * The description of the certificate profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#description CertManagerCertificateProfile#description}
  */
  readonly description?: string;
  /**
  * The enrollment type for the profile. Supported values: api, est, acme
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#enrollment_type CertManagerCertificateProfile#enrollment_type}
  */
  readonly enrollmentType: string;
  /**
  * The issuer type for the profile. Supported values: ca, self-signed. Defaults to 'ca'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#issuer_type CertManagerCertificateProfile#issuer_type}
  */
  readonly issuerType?: string;
  /**
  * The unique name of the certificate profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#name CertManagerCertificateProfile#name}
  */
  readonly name: string;
  /**
  * The slug of the cert-manager project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#project_slug CertManagerCertificateProfile#project_slug}
  */
  readonly projectSlug: string;
  /**
  * api_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#api_config CertManagerCertificateProfile#api_config}
  */
  readonly apiConfig?: CertManagerCertificateProfileApiConfig;
  /**
  * est_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#est_config CertManagerCertificateProfile#est_config}
  */
  readonly estConfig?: CertManagerCertificateProfileEstConfig;
  /**
  * external_configs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#external_configs CertManagerCertificateProfile#external_configs}
  */
...
export interface CertManagerCertificateProfileApiConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#auto_renew CertManagerCertificateProfile#auto_renew}
  */
  readonly autoRenew?: boolean | cdktf.IResolvable;
  /**
  * Number of days before expiration to renew certificates (1-30)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#renew_before_days CertManagerCertificateProfile#renew_before_days}
  */
...
export interface CertManagerCertificateProfileEstConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#ca_chain CertManagerCertificateProfile#ca_chain}
  */
  readonly caChain?: string;
  /**
  * Whether to disable bootstrap CA validation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#disable_bootstrap_ca_validation CertManagerCertificateProfile#disable_bootstrap_ca_validation}
  */
  readonly disableBootstrapCaValidation?: boolean | cdktf.IResolvable;
  /**
  * The passphrase for EST enrollment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#passphrase CertManagerCertificateProfile#passphrase}
  */
...
export interface CertManagerCertificateProfileExternalConfigs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#template CertManagerCertificateProfile#template}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile infisical_cert_manager_certificate_profile}
*/
export class CertManagerCertificateProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerCertificateProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/cert_manager_certificate_profile infisical_cert_manager_certificate_profile} Resource
  *
  * @param scope The scope in which to define this construct
