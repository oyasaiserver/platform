// https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy
...
export interface AccessApprovalPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#approvers AccessApprovalPolicy#approvers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#enforcement_level AccessApprovalPolicy#enforcement_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#environment_slug AccessApprovalPolicy#environment_slug}
  */
  readonly environmentSlug?: string;
  /**
  * The environments to apply the access approval policy to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#environment_slugs AccessApprovalPolicy#environment_slugs}
  */
  readonly environmentSlugs?: string[];
  /**
  * The name of the access approval policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#name AccessApprovalPolicy#name}
  */
  readonly name?: string;
  /**
  * The ID of the project to add the access approval policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#project_id AccessApprovalPolicy#project_id}
  */
  readonly projectId: string;
  /**
  * The number of required approvers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#required_approvals AccessApprovalPolicy#required_approvals}
  */
  readonly requiredApprovals: number;
  /**
  * The secret path to apply the access approval policy to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#secret_path AccessApprovalPolicy#secret_path}
  */
...
export interface AccessApprovalPolicyApprovers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#id AccessApprovalPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#type AccessApprovalPolicy#type}
  */
  readonly type: string;
  /**
  * The username of the approver. By default, this is the email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#username AccessApprovalPolicy#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy infisical_access_approval_policy}
*/
export class AccessApprovalPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessApprovalPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/access_approval_policy infisical_access_approval_policy} Resource
  *
  * @param scope The scope in which to define this construct
