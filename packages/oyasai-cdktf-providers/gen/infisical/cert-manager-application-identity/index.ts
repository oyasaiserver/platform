// https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity
...
export interface CertManagerApplicationIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity#application_id CertManagerApplicationIdentity#application_id}
  */
  readonly applicationId: string;
  /**
  * The ID of the identity to add
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity#identity_id CertManagerApplicationIdentity#identity_id}
  */
  readonly identityId: string;
  /**
  * The role to assign to the identity (admin, operator, or auditor)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity#role CertManagerApplicationIdentity#role}
  */
  readonly role: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity infisical_cert_manager_application_identity}
*/
export class CertManagerApplicationIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerApplicationIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/cert_manager_application_identity infisical_cert_manager_application_identity} Resource
  *
  * @param scope The scope in which to define this construct
