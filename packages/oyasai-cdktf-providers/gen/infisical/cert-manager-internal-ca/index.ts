// https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca
...
export interface CertManagerInternalCaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#common_name CertManagerInternalCa#common_name}
  */
  readonly commonName?: string;
  /**
  * The country (C) of the CA certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#country CertManagerInternalCa#country}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#key_algorithm CertManagerInternalCa#key_algorithm}
  */
  readonly keyAlgorithm?: string;
  /**
  * The locality (L) of the CA certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#locality CertManagerInternalCa#locality}
  */
  readonly locality?: string;
  /**
  * The name of the CA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#name CertManagerInternalCa#name}
  */
  readonly name: string;
  /**
  * The organization (O) of the CA certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#organization CertManagerInternalCa#organization}
  */
  readonly organization?: string;
  /**
  * The organizational unit (OU) of the CA certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#ou CertManagerInternalCa#ou}
  */
  readonly ou?: string;
  /**
  * The slug of the cert-manager project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#project_slug CertManagerInternalCa#project_slug}
  */
  readonly projectSlug: string;
  /**
  * The state/province (ST) of the CA certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#province CertManagerInternalCa#province}
  */
  readonly province?: string;
  /**
  * The status of the CA. Supported values: active, disabled. Defaults to 'active'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#status CertManagerInternalCa#status}
  */
  readonly status?: string;
  /**
  * The type of the CA. Supported values: root, intermediate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#type CertManagerInternalCa#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca infisical_cert_manager_internal_ca}
*/
export class CertManagerInternalCa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerInternalCa that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.15/docs/resources/cert_manager_internal_ca infisical_cert_manager_internal_ca} Resource
  *
  * @param scope The scope in which to define this construct
