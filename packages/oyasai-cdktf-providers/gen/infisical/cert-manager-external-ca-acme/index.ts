// https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme
...
export interface CertManagerExternalCaAcmeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#account_email CertManagerExternalCaAcme#account_email}
  */
  readonly accountEmail: string;
  /**
  * The ACME directory URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#directory_url CertManagerExternalCaAcme#directory_url}
  */
  readonly directoryUrl: string;
  /**
  * The ID of the DNS app connection for ACME challenge validation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#dns_app_connection_id CertManagerExternalCaAcme#dns_app_connection_id}
  */
  readonly dnsAppConnectionId: string;
  /**
  * The hosted zone ID for DNS-01 challenge validation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#dns_hosted_zone_id CertManagerExternalCaAcme#dns_hosted_zone_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#dns_provider CertManagerExternalCaAcme#dns_provider}
  */
  readonly dnsProvider: string;
  /**
  * External Account Binding (EAB) HMAC key (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#eab_hmac_key CertManagerExternalCaAcme#eab_hmac_key}
  */
  readonly eabHmacKey?: string;
  /**
  * External Account Binding (EAB) Key ID (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#eab_kid CertManagerExternalCaAcme#eab_kid}
  */
  readonly eabKid?: string;
  /**
  * The name of the ACME CA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#name CertManagerExternalCaAcme#name}
  */
  readonly name: string;
  /**
  * The status of the CA. Supported values: active, disabled. Defaults to 'active'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#status CertManagerExternalCaAcme#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme infisical_cert_manager_external_ca_acme}
*/
export class CertManagerExternalCaAcme extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerExternalCaAcme that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.30/docs/resources/cert_manager_external_ca_acme infisical_cert_manager_external_ca_acme} Resource
  *
  * @param scope The scope in which to define this construct
