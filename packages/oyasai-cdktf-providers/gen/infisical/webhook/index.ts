// https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#environment Webhook#environment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#events_filter Webhook#events_filter}
  */
  readonly eventsFilter?: string[];
  /**
  * Whether the webhook is disabled. Defaults to false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#is_disabled Webhook#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the project the webhook belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#project_id Webhook#project_id}
  */
  readonly projectId: string;
  /**
  * The secret path the webhook listens to. Defaults to '/'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#secret_path Webhook#secret_path}
  */
  readonly secretPath?: string;
  /**
  * The webhook type. Options: general, slack, microsoft-teams. Defaults to 'general'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#type Webhook#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#webhook_secret_key Webhook#webhook_secret_key}
  */
  readonly webhookSecretKey?: string;
  /**
  * The URL Infisical sends the event payload to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#webhook_url Webhook#webhook_url}
  */
  readonly webhookUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook infisical_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/resources/webhook infisical_webhook} Resource
  *
  * @param scope The scope in which to define this construct
