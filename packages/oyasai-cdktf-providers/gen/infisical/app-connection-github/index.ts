// https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github
...
export interface AppConnectionGithubConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#credentials AppConnectionGithub#credentials}
  */
  readonly credentials: AppConnectionGithubCredentials;
  /**
  * An optional description for the GitHub App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#description AppConnectionGithub#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with GitHub. Possible values are: pat
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#method AppConnectionGithub#method}
  */
  readonly method: string;
  /**
  * The name of the GitHub App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#name AppConnectionGithub#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#project_id AppConnectionGithub#project_id}
  */
...
export interface AppConnectionGithubCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#host AppConnectionGithub#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#instance_type AppConnectionGithub#instance_type}
  */
  readonly instanceType?: string;
  /**
  * The Personal Access Token used to access GitHub.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#personal_access_token AppConnectionGithub#personal_access_token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github infisical_app_connection_github}
*/
export class AppConnectionGithub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionGithub that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/app_connection_github infisical_app_connection_github} Resource
  *
  * @param scope The scope in which to define this construct
