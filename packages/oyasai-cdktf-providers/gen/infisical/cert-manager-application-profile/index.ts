// https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile
...
export interface CertManagerApplicationProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#acme_config CertManagerApplicationProfile#acme_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#api_config CertManagerApplicationProfile#api_config}
  */
  readonly apiConfig?: CertManagerApplicationProfileApiConfig;
  /**
  * The ID of the Certificate Manager application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#application_id CertManagerApplicationProfile#application_id}
  */
  readonly applicationId: string;
  /**
  * Enable the EST enrollment method. Omit the block to disable EST enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#est_config CertManagerApplicationProfile#est_config}
  */
  readonly estConfig?: CertManagerApplicationProfileEstConfig;
  /**
  * The ID of the certificate profile to attach
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#profile_id CertManagerApplicationProfile#profile_id}
  */
  readonly profileId: string;
  /**
  * Enable the SCEP enrollment method. Omit the block to disable SCEP enrollment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#scep_config CertManagerApplicationProfile#scep_config}
  */
...
export interface CertManagerApplicationProfileAcmeConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#skip_dns_ownership_verification CertManagerApplicationProfile#skip_dns_ownership_verification}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#skip_eab_binding CertManagerApplicationProfile#skip_eab_binding}
  */
...
export interface CertManagerApplicationProfileApiConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#auto_renew CertManagerApplicationProfile#auto_renew}
  */
  readonly autoRenew?: boolean | cdktf.IResolvable;
  /**
  * Number of days before expiration to renew (1-30). Defaults to 7 when omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#renew_before_days CertManagerApplicationProfile#renew_before_days}
  */
...
export interface CertManagerApplicationProfileEstConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#ca_chain CertManagerApplicationProfile#ca_chain}
  */
  readonly caChain?: string;
  /**
  * Whether to disable bootstrap CA validation. Defaults to false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#disable_bootstrap_ca_validation CertManagerApplicationProfile#disable_bootstrap_ca_validation}
  */
  readonly disableBootstrapCaValidation?: boolean | cdktf.IResolvable;
  /**
  * EST passphrase used to authorize certificate requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#passphrase CertManagerApplicationProfile#passphrase}
  */
...
export interface CertManagerApplicationProfileScepConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#allow_cert_based_renewal CertManagerApplicationProfile#allow_cert_based_renewal}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#challenge_password CertManagerApplicationProfile#challenge_password}
  */
  readonly challengePassword?: string;
  /**
  * SCEP challenge type. Supported values: static, dynamic. Defaults to static.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#challenge_type CertManagerApplicationProfile#challenge_type}
  */
  readonly challengeType?: string;
  /**
  * Expiry of a dynamic challenge in minutes (1-1440). Only used when challenge_type is dynamic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#dynamic_challenge_expiry_minutes CertManagerApplicationProfile#dynamic_challenge_expiry_minutes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#dynamic_challenge_max_pending CertManagerApplicationProfile#dynamic_challenge_max_pending}
  */
  readonly dynamicChallengeMaxPending?: number;
  /**
  * Include the issuing CA certificate in SCEP responses. Defaults to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#include_ca_cert_in_response CertManagerApplicationProfile#include_ca_cert_in_response}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile infisical_cert_manager_application_profile}
*/
export class CertManagerApplicationProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerApplicationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.28/docs/resources/cert_manager_application_profile infisical_cert_manager_application_profile} Resource
  *
  * @param scope The scope in which to define this construct
