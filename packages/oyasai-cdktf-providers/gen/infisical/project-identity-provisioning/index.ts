// https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning
...
export interface ProjectIdentityProvisioningConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#has_delete_protection ProjectIdentityProvisioning#has_delete_protection}
  */
  readonly hasDeleteProtection?: boolean | cdktf.IResolvable;
  /**
  * The metadata associated with this identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#metadata ProjectIdentityProvisioning#metadata}
  */
  readonly metadata?: ProjectIdentityProvisioningMetadata[] | cdktf.IResolvable;
  /**
  * The name of the identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#name ProjectIdentityProvisioning#name}
  */
  readonly name: string;
  /**
  * The ID of the project that owns this identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#project_id ProjectIdentityProvisioning#project_id}
  */
...
export interface ProjectIdentityProvisioningMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#key ProjectIdentityProvisioning#key}
  */
  readonly key: string;
  /**
  * The value of the metadata entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#value ProjectIdentityProvisioning#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning infisical_project_identity_provisioning}
*/
export class ProjectIdentityProvisioning extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIdentityProvisioning that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.17/docs/resources/project_identity_provisioning infisical_project_identity_provisioning} Resource
  *
  * @param scope The scope in which to define this construct
