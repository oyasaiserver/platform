// https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user
...
export interface DataInfisicalProjectUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user#project_id DataInfisicalProjectUser#project_id}
  */
  readonly projectId: string;
  /**
  * The user's Infisical UUID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user#user_id DataInfisicalProjectUser#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user infisical_project_user}
*/
export class DataInfisicalProjectUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalProjectUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.35/docs/data-sources/project_user infisical_project_user} Data Source
  *
  * @param scope The scope in which to define this construct
