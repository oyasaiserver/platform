...
export function secretSyncSupabaseDestinationConfigToTerraform(struct) {
...
export function secretSyncSupabaseDestinationConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncSupabaseSyncOptionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncSupabaseSyncOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncSupabase extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_sync_supabase";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _destinationConfig = new SecretSyncSupabaseDestinationConfigOutputReference(this, "destination_config");
    ...
    _syncOptions = new SecretSyncSupabaseSyncOptionsOutputReference(this, "sync_options");
    get syncOptions() {
