// https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity
...
export interface ProjectScopedIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#has_delete_protection ProjectScopedIdentity#has_delete_protection}
  */
  readonly hasDeleteProtection?: boolean | cdktf.IResolvable;
  /**
  * The metadata associated with this identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#metadata ProjectScopedIdentity#metadata}
  */
  readonly metadata?: ProjectScopedIdentityMetadata[] | cdktf.IResolvable;
  /**
  * The name of the identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#name ProjectScopedIdentity#name}
  */
  readonly name: string;
  /**
  * The ID of the project that owns this identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#project_id ProjectScopedIdentity#project_id}
  */
  readonly projectId: string;
  /**
  * The roles assigned to the project-scoped identity. At least one permanent (non-temporary) role is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#roles ProjectScopedIdentity#roles}
  */
...
export interface ProjectScopedIdentityMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#key ProjectScopedIdentity#key}
  */
  readonly key: string;
  /**
  * The value of the metadata entry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#value ProjectScopedIdentity#value}
  */
...
export interface ProjectScopedIdentityRoles {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#is_temporary ProjectScopedIdentity#is_temporary}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#role_slug ProjectScopedIdentity#role_slug}
  */
  readonly roleSlug: string;
  /**
  * ISO time for which temporary access will end. Computed based on temporary_range and temporary_access_start_time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#temporary_access_end_time ProjectScopedIdentity#temporary_access_end_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#temporary_access_start_time ProjectScopedIdentity#temporary_access_start_time}
  */
  readonly temporaryAccessStartTime?: string;
  /**
  * Type of temporary access given. Types: relative. Default: relative
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#temporary_mode ProjectScopedIdentity#temporary_mode}
  */
  readonly temporaryMode?: string;
  /**
  * TTL for the temporary time. Eg: 1m, 1h, 1d. Default: 1h
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#temporary_range ProjectScopedIdentity#temporary_range}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity infisical_project_scoped_identity}
*/
export class ProjectScopedIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectScopedIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/project_scoped_identity infisical_project_scoped_identity} Resource
  *
  * @param scope The scope in which to define this construct
