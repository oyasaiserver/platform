// https://registry.terraform.io/providers/infisical/infisical/0.16.18/docs/resources/secret_sync_cloudflare_workers
// generated from terraform resource schema
import * as cdktf from 'cdktf';
export function secretSyncCloudflareWorkersDestinationConfigToTerraform(struct) {
...
export function secretSyncCloudflareWorkersDestinationConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncCloudflareWorkersSyncOptionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncCloudflareWorkersSyncOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncCloudflareWorkers extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_sync_cloudflare_workers";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _destinationConfig = new SecretSyncCloudflareWorkersDestinationConfigOutputReference(this, "destination_config");
    ...
    _syncOptions = new SecretSyncCloudflareWorkersSyncOptionsOutputReference(this, "sync_options");
    get syncOptions() {
