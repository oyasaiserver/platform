...
export function identityUniversalAuthAccessTokenTrustedIpsToTerraform(struct) {
...
export function identityUniversalAuthAccessTokenTrustedIpsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function identityUniversalAuthClientSecretTrustedIpsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function identityUniversalAuthClientSecretTrustedIpsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class IdentityUniversalAuth extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_identity_universal_auth";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _accessTokenTrustedIps = new IdentityUniversalAuthAccessTokenTrustedIpsList(this, "access_token_trusted_ips", false);
    ...
    _clientSecretTrustedIps = new IdentityUniversalAuthClientSecretTrustedIpsList(this, "client_secret_trusted_ips", false);
    get clientSecretTrustedIps() {
        return this._clientSecretTrustedIps;
    }
    putClientSecretTrustedIps(value) {
        this._clientSecretTrustedIps.internalValue = value;
    }
    resetClientSecretTrustedIps() {
        this._clientSecretTrustedIps.internalValue = undefined;
    }
    // Temporarily expose input value. Use with caution.
    get clientSecretTrustedIpsInput() {
