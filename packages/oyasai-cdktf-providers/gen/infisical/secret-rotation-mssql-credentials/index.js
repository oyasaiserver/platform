...
export function secretRotationMssqlCredentialsParametersToTerraform(struct) {
...
export function secretRotationMssqlCredentialsParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsRotateAtUtcToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsRotateAtUtcToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsSecretsMappingToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsSecretsMappingToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsTemporaryParametersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationMssqlCredentialsTemporaryParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretRotationMssqlCredentials extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_rotation_mssql_credentials";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _parameters = new SecretRotationMssqlCredentialsParametersOutputReference(this, "parameters");
    get parameters() {
    ...
    _rotateAtUtc = new SecretRotationMssqlCredentialsRotateAtUtcOutputReference(this, "rotate_at_utc");
    get rotateAtUtc() {
    ...
    _secretsMapping = new SecretRotationMssqlCredentialsSecretsMappingOutputReference(this, "secrets_mapping");
    get secretsMapping() {
    ...
    _temporaryParameters = new SecretRotationMssqlCredentialsTemporaryParametersOutputReference(this, "temporary_parameters");
