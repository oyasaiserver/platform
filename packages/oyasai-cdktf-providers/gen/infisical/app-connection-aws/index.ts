// https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws
...
export interface AppConnectionAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#credentials AppConnectionAws#credentials}
  */
  readonly credentials: AppConnectionAwsCredentials;
  /**
  * An optional description for the AWS App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#description AppConnectionAws#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with AWS. Possible values are: assume-role, access-key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#method AppConnectionAws#method}
  */
  readonly method: string;
  /**
  * The name of the AWS App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#name AppConnectionAws#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#project_id AppConnectionAws#project_id}
  */
...
export interface AppConnectionAwsCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#access_key_id AppConnectionAws#access_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#role_arn AppConnectionAws#role_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#secret_access_key AppConnectionAws#secret_access_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws infisical_app_connection_aws}
*/
export class AppConnectionAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.22/docs/resources/app_connection_aws infisical_app_connection_aws} Resource
  *
  * @param scope The scope in which to define this construct
