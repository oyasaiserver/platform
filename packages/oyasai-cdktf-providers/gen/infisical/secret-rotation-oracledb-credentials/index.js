...
export function secretRotationOracledbCredentialsParametersToTerraform(struct) {
...
export function secretRotationOracledbCredentialsParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsRotateAtUtcToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsRotateAtUtcToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsSecretsMappingToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsSecretsMappingToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsTemporaryParametersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretRotationOracledbCredentialsTemporaryParametersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretRotationOracledbCredentials extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_rotation_oracledb_credentials";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _parameters = new SecretRotationOracledbCredentialsParametersOutputReference(this, "parameters");
    get parameters() {
    ...
    _rotateAtUtc = new SecretRotationOracledbCredentialsRotateAtUtcOutputReference(this, "rotate_at_utc");
    get rotateAtUtc() {
    ...
    _secretsMapping = new SecretRotationOracledbCredentialsSecretsMappingOutputReference(this, "secrets_mapping");
    get secretsMapping() {
    ...
    _temporaryParameters = new SecretRotationOracledbCredentialsTemporaryParametersOutputReference(this, "temporary_parameters");
