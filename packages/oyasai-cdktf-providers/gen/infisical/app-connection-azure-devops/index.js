...
export function appConnectionAzureDevopsCredentialsToTerraform(struct) {
...
export function appConnectionAzureDevopsCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AppConnectionAzureDevops extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_app_connection_azure_devops";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _credentials = new AppConnectionAzureDevopsCredentialsOutputReference(this, "credentials");
    get credentials() {
