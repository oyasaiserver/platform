...
export function identityTokenAuthAccessTokenTrustedIpsToTerraform(struct) {
...
export function identityTokenAuthAccessTokenTrustedIpsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class IdentityTokenAuth extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_identity_token_auth";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _accessTokenTrustedIps = new IdentityTokenAuthAccessTokenTrustedIpsList(this, "access_token_trusted_ips", false);
