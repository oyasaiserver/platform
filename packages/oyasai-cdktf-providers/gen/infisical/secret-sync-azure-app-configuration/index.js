...
export function secretSyncAzureAppConfigurationDestinationConfigToTerraform(struct) {
...
export function secretSyncAzureAppConfigurationDestinationConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAzureAppConfigurationSyncOptionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAzureAppConfigurationSyncOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncAzureAppConfiguration extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_sync_azure_app_configuration";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _destinationConfig = new SecretSyncAzureAppConfigurationDestinationConfigOutputReference(this, "destination_config");
    ...
    _syncOptions = new SecretSyncAzureAppConfigurationSyncOptionsOutputReference(this, "sync_options");
    get syncOptions() {
