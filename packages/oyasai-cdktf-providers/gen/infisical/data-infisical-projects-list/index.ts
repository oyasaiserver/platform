// https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/data-sources/projects_list
...
export interface DataInfisicalProjectsListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/data-sources/projects_list#slugs DataInfisicalProjectsList#slugs}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/data-sources/projects_list infisical_projects_list}
*/
export class DataInfisicalProjectsList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalProjectsList that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/data-sources/projects_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.19.31/docs/data-sources/projects_list infisical_projects_list} Data Source
  *
  * @param scope The scope in which to define this construct
