...
export function secretSyncAzureKeyVaultDestinationConfigToTerraform(struct) {
...
export function secretSyncAzureKeyVaultDestinationConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncAzureKeyVaultDestinationConfigOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    set vaultBaseUrl(value) {
        this._vaultBaseUrl = value;
    }
    // Temporarily expose input value. Use with caution.
    get vaultBaseUrlInput() {
        return this._vaultBaseUrl;
    }
}
export function secretSyncAzureKeyVaultSyncOptionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAzureKeyVaultSyncOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncAzureKeyVault extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_sync_azure_key_vault";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _destinationConfig = new SecretSyncAzureKeyVaultDestinationConfigOutputReference(this, "destination_config");
    ...
    _syncOptions = new SecretSyncAzureKeyVaultSyncOptionsOutputReference(this, "sync_options");
    get syncOptions() {
