// https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager
...
export interface IntegrationAwsSecretsManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#access_key_id IntegrationAwsSecretsManager#access_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#assume_role_arn IntegrationAwsSecretsManager#assume_role_arn}
  */
  readonly assumeRoleArn?: string;
  /**
  * The AWS region to sync secrets to. (us-east-1, us-east-2, etc)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#aws_region IntegrationAwsSecretsManager#aws_region}
  */
  readonly awsRegion: string;
  /**
  * The slug of the environment to sync to AWS Secrets Manager (prod, dev, staging, etc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#environment IntegrationAwsSecretsManager#environment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#mapping_behavior IntegrationAwsSecretsManager#mapping_behavior}
  */
  readonly mappingBehavior?: string;
  /**
  * Integration options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#options IntegrationAwsSecretsManager#options}
  */
  readonly options?: IntegrationAwsSecretsManagerOptions;
  /**
  * The ID of your Infisical project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#project_id IntegrationAwsSecretsManager#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#secret_access_key IntegrationAwsSecretsManager#secret_access_key}
  */
  readonly secretAccessKey?: string;
  /**
  * The secret path in Infisical to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#secret_path IntegrationAwsSecretsManager#secret_path}
  */
  readonly secretPath: string;
  /**
  * The path in AWS Secrets Manager to sync secrets to. This is required if mapping_behavior is 'many-to-one'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#secrets_manager_path IntegrationAwsSecretsManager#secrets_manager_path}
  */
...
export interface IntegrationAwsSecretsManagerOptionsAwsTags {
  ...
  * The key of the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#key IntegrationAwsSecretsManager#key}
  */
  readonly key?: string;
  /**
  * The value of the tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#value IntegrationAwsSecretsManager#value}
  */
...
export interface IntegrationAwsSecretsManagerOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#aws_tags IntegrationAwsSecretsManager#aws_tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#metadata_sync_mode IntegrationAwsSecretsManager#metadata_sync_mode}
  */
  readonly metadataSyncMode?: string;
  /**
  * The prefix to add to the secret name in AWS Secrets Manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#secret_prefix IntegrationAwsSecretsManager#secret_prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager infisical_integration_aws_secrets_manager}
*/
export class IntegrationAwsSecretsManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAwsSecretsManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/integration_aws_secrets_manager infisical_integration_aws_secrets_manager} Resource
  *
  * @param scope The scope in which to define this construct
