// https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate
...
export interface CertManagerCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#alt_names CertManagerCertificate#alt_names}
  */
  readonly altNames?: string[];
  /**
  * The common name (CN) for the certificate. Required when not using CSR
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#common_name CertManagerCertificate#common_name}
  */
  readonly commonName?: string;
  /**
  * The country (C) for the certificate (2-letter code)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#country CertManagerCertificate#country}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#csr CertManagerCertificate#csr}
  */
  readonly csr?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#extended_key_usages CertManagerCertificate#extended_key_usages}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#key_algorithm CertManagerCertificate#key_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#key_usages CertManagerCertificate#key_usages}
  */
  readonly keyUsages?: string[];
  /**
  * The locality (L) for the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#locality CertManagerCertificate#locality}
  */
  readonly locality?: string;
  /**
  * The organization (O) for the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#organization CertManagerCertificate#organization}
  */
  readonly organization?: string;
  /**
  * The organizational unit (OU) for the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#ou CertManagerCertificate#ou}
  */
  readonly ou?: string;
  /**
  * The ID of the certificate profile to use for issuance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#profile_id CertManagerCertificate#profile_id}
  */
  readonly profileId: string;
  /**
  * The state/province (ST) for the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#province CertManagerCertificate#province}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#signature_algorithm CertManagerCertificate#signature_algorithm}
  */
  readonly signatureAlgorithm?: string;
  /**
  * Maximum time to wait for certificate issuance in seconds. Defaults to 3600 (1 hour)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#timeout_seconds CertManagerCertificate#timeout_seconds}
  */
  readonly timeoutSeconds?: number;
  /**
  * Time to live for the certificate (e.g., '30d', '90d', '1y')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#ttl CertManagerCertificate#ttl}
  */
  readonly ttl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate infisical_cert_manager_certificate}
*/
export class CertManagerCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CertManagerCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.16.25/docs/resources/cert_manager_certificate infisical_cert_manager_certificate} Resource
  *
  * @param scope The scope in which to define this construct
