...
export function appConnectionPostgresCredentialsToTerraform(struct) {
...
export function appConnectionPostgresCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AppConnectionPostgres extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_app_connection_postgres";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _credentials = new AppConnectionPostgresCredentialsOutputReference(this, "credentials");
    get credentials() {
