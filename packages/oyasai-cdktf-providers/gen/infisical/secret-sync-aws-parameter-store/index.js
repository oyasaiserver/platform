...
export function secretSyncAwsParameterStoreDestinationConfigToTerraform(struct) {
...
export function secretSyncAwsParameterStoreDestinationConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAwsParameterStoreSyncOptionsTagsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAwsParameterStoreSyncOptionsTagsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAwsParameterStoreSyncOptionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function secretSyncAwsParameterStoreSyncOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class SecretSyncAwsParameterStoreSyncOptionsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _tags = new SecretSyncAwsParameterStoreSyncOptionsTagsList(this, "tags", true);
    get tags() {
        return this._tags;
    }
    putTags(value) {
...
export class SecretSyncAwsParameterStore extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "infisical_secret_sync_aws_parameter_store";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _destinationConfig = new SecretSyncAwsParameterStoreDestinationConfigOutputReference(this, "destination_config");
    ...
    _syncOptions = new SecretSyncAwsParameterStoreSyncOptionsOutputReference(this, "sync_options");
    get syncOptions() {
