// https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws
...
export interface ExternalKmsAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#configuration ExternalKmsAws#configuration}
  */
  readonly configuration: ExternalKmsAwsConfiguration;
  /**
  * An optional description for the KMS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#description ExternalKmsAws#description}
  */
  readonly description?: string;
  /**
  * The name of the KMS to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#name ExternalKmsAws#name}
  */
...
export interface ExternalKmsAwsConfigurationCredential {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#access_key_id ExternalKmsAws#access_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#role_arn ExternalKmsAws#role_arn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#role_external_id ExternalKmsAws#role_external_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#secret_access_key ExternalKmsAws#secret_access_key}
  */
...
export interface ExternalKmsAwsConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#aws_kms_key_id ExternalKmsAws#aws_kms_key_id}
  */
  readonly awsKmsKeyId: string;
  /**
  * The AWS region where the KMS key is located
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#aws_region ExternalKmsAws#aws_region}
  */
  readonly awsRegion: string;
  /**
  * The AWS credentials for the external KMS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#credential ExternalKmsAws#credential}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#type ExternalKmsAws#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws infisical_external_kms_aws}
*/
export class ExternalKmsAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExternalKmsAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.18.0/docs/resources/external_kms_aws infisical_external_kms_aws} Resource
  *
  * @param scope The scope in which to define this construct
