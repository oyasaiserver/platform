...
export function dataCloudflareZeroTrustListsResultItemsToTerraform(struct) {
...
export function dataCloudflareZeroTrustListsResultItemsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustListsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustListsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustListsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _items = new DataCloudflareZeroTrustListsResultItemsList(this, "items", true);
    get items() {
        return this._items;
    }
...
export class DataCloudflareZeroTrustLists extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_lists";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustListsResultList(this, "result", false);
    get result() {
        return this._result;
    }
