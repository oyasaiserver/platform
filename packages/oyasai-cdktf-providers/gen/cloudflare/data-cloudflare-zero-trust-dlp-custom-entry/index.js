...
export function dataCloudflareZeroTrustDlpCustomEntryConfidenceToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpCustomEntryConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryProfilesToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryProfilesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntryVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpCustomEntry extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _confidence = new DataCloudflareZeroTrustDlpCustomEntryConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new DataCloudflareZeroTrustDlpCustomEntryPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _profiles = new DataCloudflareZeroTrustDlpCustomEntryProfilesList(this, "profiles", false);
    get profiles() {
    ...
    _variant = new DataCloudflareZeroTrustDlpCustomEntryVariantOutputReference(this, "variant");
    get variant() {
