...
export function dataCloudflareLeakedCredentialCheckRulesResultToTerraform(struct) {
...
export function dataCloudflareLeakedCredentialCheckRulesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareLeakedCredentialCheckRules extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_leaked_credential_check_rules";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareLeakedCredentialCheckRulesResultList(this, "result", false);
    get result() {
        return this._result;
    }
