...
export function dataCloudflareAuthenticatedOriginPullsHostnameCertificatesResultToTerraform(struct) {
...
export function dataCloudflareAuthenticatedOriginPullsHostnameCertificatesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareAuthenticatedOriginPullsHostnameCertificates extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_authenticated_origin_pulls_hostname_certificates";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareAuthenticatedOriginPullsHostnameCertificatesResultList(this, "result", false);
    get result() {
        return this._result;
    }
