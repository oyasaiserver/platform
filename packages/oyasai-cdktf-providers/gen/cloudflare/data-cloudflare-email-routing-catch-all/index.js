...
export function dataCloudflareEmailRoutingCatchAllActionsToTerraform(struct) {
...
export function dataCloudflareEmailRoutingCatchAllActionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareEmailRoutingCatchAllMatchersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareEmailRoutingCatchAllMatchersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareEmailRoutingCatchAll extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _actions = new DataCloudflareEmailRoutingCatchAllActionsList(this, "actions", false);
    get actions() {
    ...
    _matchers = new DataCloudflareEmailRoutingCatchAllMatchersList(this, "matchers", false);
    get matchers() {
