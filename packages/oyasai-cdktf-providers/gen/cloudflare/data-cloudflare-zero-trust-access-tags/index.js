...
export function dataCloudflareZeroTrustAccessTagsResultToTerraform(struct) {
...
export function dataCloudflareZeroTrustAccessTagsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustAccessTags extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_access_tags";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustAccessTagsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
