...
export function dataCloudflarePipelineTablesToTerraform(struct) {
...
export function dataCloudflarePipelineTablesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflarePipeline extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_pipeline";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _tables = new DataCloudflarePipelineTablesList(this, "tables", false);
    get tables() {
        return this._tables;
    }
    // =========
