...
export function dataCloudflareDnsZoneTransfersPeersResultToTerraform(struct) {
...
export function dataCloudflareDnsZoneTransfersPeersResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareDnsZoneTransfersPeers extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_dns_zone_transfers_peers";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareDnsZoneTransfersPeersResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
