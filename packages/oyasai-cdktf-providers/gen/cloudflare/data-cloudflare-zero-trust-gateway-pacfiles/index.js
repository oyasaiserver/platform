...
export function dataCloudflareZeroTrustGatewayPacfilesResultToTerraform(struct) {
...
export function dataCloudflareZeroTrustGatewayPacfilesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustGatewayPacfiles extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_gateway_pacfiles";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustGatewayPacfilesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
