...
export function dataCloudflareZeroTrustGatewayProxyEndpointsResultToTerraform(struct) {
...
export function dataCloudflareZeroTrustGatewayProxyEndpointsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustGatewayProxyEndpoints extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_gateway_proxy_endpoints";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustGatewayProxyEndpointsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
