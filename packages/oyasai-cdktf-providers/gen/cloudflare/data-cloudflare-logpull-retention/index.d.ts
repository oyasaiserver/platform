...
*/
export declare class DataCloudflareLogpullRetention extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareLogpullRetentionConfig);
    get flag(): any;
    get id(): any;
    private _zoneId?;
    get zoneId(): string;
