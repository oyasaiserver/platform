...
export function dataCloudflareNotificationPolicyWebhooksListResultToTerraform(struct) {
...
export function dataCloudflareNotificationPolicyWebhooksListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareNotificationPolicyWebhooksList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_notification_policy_webhooks_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareNotificationPolicyWebhooksListResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
