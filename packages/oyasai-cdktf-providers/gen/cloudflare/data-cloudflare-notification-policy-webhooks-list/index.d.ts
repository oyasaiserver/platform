...
export declare function dataCloudflareNotificationPolicyWebhooksListResultToTerraform(struct?: DataCloudflareNotificationPolicyWebhooksListResult): any;
export declare function dataCloudflareNotificationPolicyWebhooksListResultToHclTerraform(struct?: DataCloudflareNotificationPolicyWebhooksListResult): any;
export declare class DataCloudflareNotificationPolicyWebhooksListResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataCloudflareNotificationPolicyWebhooksListResult | undefined;
    set internalValue(value: DataCloudflareNotificationPolicyWebhooksListResult | undefined);
    get createdAt(): any;
    get id(): any;
    get lastFailure(): any;
    get lastSuccess(): any;
...
export declare class DataCloudflareNotificationPolicyWebhooksListResultList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataCloudflareNotificationPolicyWebhooksListResultOutputReference;
}
/**
...
*/
export declare class DataCloudflareNotificationPolicyWebhooksList extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "cloudflare_notification_policy_webhooks_list";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareNotificationPolicyWebhooksListConfig);
    private _accountId?;
    ...
    private _result;
    get result(): DataCloudflareNotificationPolicyWebhooksListResultList;
