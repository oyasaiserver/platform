...
export function dataCloudflareZeroTrustAccessMtlsCertificatesResultToTerraform(struct) {
...
export function dataCloudflareZeroTrustAccessMtlsCertificatesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustAccessMtlsCertificates extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_access_mtls_certificates";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustAccessMtlsCertificatesResultList(this, "result", false);
    get result() {
        return this._result;
    }
