...
export function dataCloudflareCallsTurnAppsResultToTerraform(struct) {
...
export function dataCloudflareCallsTurnAppsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareCallsTurnApps extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_calls_turn_apps";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareCallsTurnAppsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
