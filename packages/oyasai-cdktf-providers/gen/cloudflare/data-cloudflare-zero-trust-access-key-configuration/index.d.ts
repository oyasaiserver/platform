...
*/
export declare class DataCloudflareZeroTrustAccessKeyConfiguration extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareZeroTrustAccessKeyConfigurationConfig);
    private _accountId?;
    ...
    get id(): any;
    get keyRotationIntervalDays(): any;
