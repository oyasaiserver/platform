...
export function managedTransformsManagedRequestHeadersToTerraform(struct) {
...
export function managedTransformsManagedRequestHeadersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function managedTransformsManagedResponseHeadersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function managedTransformsManagedResponseHeadersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class ManagedTransforms extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_managed_transforms";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _managedRequestHeaders = new ManagedTransformsManagedRequestHeadersList(this, "managed_request_headers", true);
    get managedRequestHeaders() {
        return this._managedRequestHeaders;
    }
    putManagedRequestHeaders(value) {
        this._managedRequestHeaders.internalValue = value;
    }
    // Temporarily expose input value. Use with caution.
    get managedRequestHeadersInput() {
        return this._managedRequestHeaders.internalValue;
    }
    // managed_response_headers - computed: false, optional: false, required: true
    _managedResponseHeaders = new ManagedTransformsManagedResponseHeadersList(this, "managed_response_headers", true);
    get managedResponseHeaders() {
        return this._managedResponseHeaders;
    }
    putManagedResponseHeaders(value) {
        this._managedResponseHeaders.internalValue = value;
    }
    // Temporarily expose input value. Use with caution.
    get managedResponseHeadersInput() {
