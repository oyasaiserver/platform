...
export function dataCloudflareApiShieldSchemasResultToTerraform(struct) {
...
export function dataCloudflareApiShieldSchemasResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareApiShieldSchemas extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_api_shield_schemas";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareApiShieldSchemasResultList(this, "result", false);
    get result() {
        return this._result;
    }
