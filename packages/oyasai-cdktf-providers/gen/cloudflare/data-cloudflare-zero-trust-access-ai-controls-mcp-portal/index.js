...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalFilterToTerraform(struct) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalFilterToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedPromptsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedPromptsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedToolsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedToolsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustAccessAiControlsMcpPortalServersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustAccessAiControlsMcpPortalServersOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _updatedPrompts = new DataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedPromptsList(this, "updated_prompts", false);
    get updatedPrompts() {
        return this._updatedPrompts;
    }
    // updated_tools - computed: true, optional: false, required: false
    _updatedTools = new DataCloudflareZeroTrustAccessAiControlsMcpPortalServersUpdatedToolsList(this, "updated_tools", false);
    get updatedTools() {
...
export class DataCloudflareZeroTrustAccessAiControlsMcpPortal extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _filter = new DataCloudflareZeroTrustAccessAiControlsMcpPortalFilterOutputReference(this, "filter");
    get filter() {
        return this._filter;
    }
    putFilter(value) {
    ...
    _servers = new DataCloudflareZeroTrustAccessAiControlsMcpPortalServersList(this, "servers", false);
    get servers() {
