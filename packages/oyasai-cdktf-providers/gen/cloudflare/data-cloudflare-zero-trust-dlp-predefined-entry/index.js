...
export function dataCloudflareZeroTrustDlpPredefinedEntryConfidenceToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryProfilesToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryProfilesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpPredefinedEntryVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpPredefinedEntry extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _confidence = new DataCloudflareZeroTrustDlpPredefinedEntryConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new DataCloudflareZeroTrustDlpPredefinedEntryPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _profiles = new DataCloudflareZeroTrustDlpPredefinedEntryProfilesList(this, "profiles", false);
    get profiles() {
    ...
    _variant = new DataCloudflareZeroTrustDlpPredefinedEntryVariantOutputReference(this, "variant");
    get variant() {
