...
export function dataCloudflareStreamAudioTrackAudioToTerraform(struct) {
...
export function dataCloudflareStreamAudioTrackAudioToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareStreamAudioTrack extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _audio = new DataCloudflareStreamAudioTrackAudioList(this, "audio", false);
    get audio() {
        return this._audio;
    }
