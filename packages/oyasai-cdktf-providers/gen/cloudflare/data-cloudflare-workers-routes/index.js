...
export function dataCloudflareWorkersRoutesResultToTerraform(struct) {
...
export function dataCloudflareWorkersRoutesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareWorkersRoutes extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_workers_routes";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareWorkersRoutesResultList(this, "result", false);
    get result() {
        return this._result;
    }
