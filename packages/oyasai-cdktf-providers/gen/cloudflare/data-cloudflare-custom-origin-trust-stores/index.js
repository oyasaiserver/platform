...
export function dataCloudflareCustomOriginTrustStoresResultToTerraform(struct) {
...
export function dataCloudflareCustomOriginTrustStoresResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareCustomOriginTrustStores extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_custom_origin_trust_stores";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareCustomOriginTrustStoresResultList(this, "result", false);
    get result() {
        return this._result;
    }
