...
export function dataCloudflareCustomPagesListResultToTerraform(struct) {
...
export function dataCloudflareCustomPagesListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareCustomPagesList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_custom_pages_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareCustomPagesListResultList(this, "result", false);
    get result() {
        return this._result;
    }
