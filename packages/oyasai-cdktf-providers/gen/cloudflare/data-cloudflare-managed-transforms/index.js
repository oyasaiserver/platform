...
export function dataCloudflareManagedTransformsManagedRequestHeadersToTerraform(struct) {
...
export function dataCloudflareManagedTransformsManagedRequestHeadersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareManagedTransformsManagedResponseHeadersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareManagedTransformsManagedResponseHeadersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareManagedTransforms extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _managedRequestHeaders = new DataCloudflareManagedTransformsManagedRequestHeadersList(this, "managed_request_headers", false);
    ...
    _managedResponseHeaders = new DataCloudflareManagedTransformsManagedResponseHeadersList(this, "managed_response_headers", false);
