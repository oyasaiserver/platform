...
export function dataCloudflareZeroTrustDlpIntegrationEntryConfidenceToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryProfilesToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryProfilesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpIntegrationEntryVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpIntegrationEntry extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _confidence = new DataCloudflareZeroTrustDlpIntegrationEntryConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new DataCloudflareZeroTrustDlpIntegrationEntryPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _profiles = new DataCloudflareZeroTrustDlpIntegrationEntryProfilesList(this, "profiles", false);
    get profiles() {
    ...
    _variant = new DataCloudflareZeroTrustDlpIntegrationEntryVariantOutputReference(this, "variant");
    get variant() {
