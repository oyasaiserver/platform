...
*/
export declare class DataCloudflareAuthenticatedOriginPullsCertificate extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataCloudflareAuthenticatedOriginPullsCertificateConfig);
    get certificate(): any;
