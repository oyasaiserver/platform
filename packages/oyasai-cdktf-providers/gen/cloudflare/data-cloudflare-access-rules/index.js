...
export function dataCloudflareAccessRulesConfigurationToTerraform(struct) {
...
export function dataCloudflareAccessRulesConfigurationToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultConfigurationToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultConfigurationToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultScopeToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultScopeToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareAccessRulesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareAccessRulesResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _configuration = new DataCloudflareAccessRulesResultConfigurationOutputReference(this, "configuration");
    get configuration() {
    ...
    _scope = new DataCloudflareAccessRulesResultScopeOutputReference(this, "scope");
    get scope() {
        return this._scope;
    }
}
...
export class DataCloudflareAccessRules extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_access_rules";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _configuration = new DataCloudflareAccessRulesConfigurationOutputReference(this, "configuration");
    get configuration() {
        return this._configuration;
    }
    ...
    _result = new DataCloudflareAccessRulesResultList(this, "result", false);
    get result() {
        return this._result;
    }
