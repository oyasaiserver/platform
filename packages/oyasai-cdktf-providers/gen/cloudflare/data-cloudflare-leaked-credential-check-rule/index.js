...
exports.DataCloudflareLeakedCredentialCheckRule = void 0;
...
*/
var DataCloudflareLeakedCredentialCheckRule = /** @class */ (function (_super) {
    __extends(DataCloudflareLeakedCredentialCheckRule, _super);
    // ===========
    // INITIALIZER
    // ===========
    /**
    ...
    */
    function DataCloudflareLeakedCredentialCheckRule(scope, id, config) {
        ...
        _this._detectionId = config.detectionId;
    ...
    */
    DataCloudflareLeakedCredentialCheckRule.generateConfigForImport = function (scope, importToId, importFromId, provider) {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "detectionId", {
        get: function () {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "detectionIdInput", {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "id", {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "password", {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "username", {
    ...
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "zoneId", {
        get: function () {
    ...
    DataCloudflareLeakedCredentialCheckRule.prototype.resetZoneId = function () {
        this._zoneId = undefined;
    };
    Object.defineProperty(DataCloudflareLeakedCredentialCheckRule.prototype, "zoneIdInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
            return this._zoneId;
        },
    ...
    // SYNTHESIS
    // =========
    DataCloudflareLeakedCredentialCheckRule.prototype.synthesizeAttributes = function () {
        return {
            detection_id: cdktf.stringToTerraform(this._detectionId),
            zone_id: cdktf.stringToTerraform(this._zoneId),
        };
    };
    DataCloudflareLeakedCredentialCheckRule.prototype.synthesizeHclAttributes = function () {
        var attrs = {
            detection_id: {
    ...
    // STATIC PROPERTIES
    // =================
    DataCloudflareLeakedCredentialCheckRule.tfResourceType = "cloudflare_leaked_credential_check_rule";
    return DataCloudflareLeakedCredentialCheckRule;
}(cdktf.TerraformDataSource));
exports.DataCloudflareLeakedCredentialCheckRule = DataCloudflareLeakedCredentialCheckRule;
