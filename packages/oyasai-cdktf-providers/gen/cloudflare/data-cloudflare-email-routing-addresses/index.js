...
export function dataCloudflareEmailRoutingAddressesResultToTerraform(struct) {
...
export function dataCloudflareEmailRoutingAddressesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareEmailRoutingAddresses extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_email_routing_addresses";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareEmailRoutingAddressesResultList(this, "result", false);
    get result() {
        return this._result;
    }
