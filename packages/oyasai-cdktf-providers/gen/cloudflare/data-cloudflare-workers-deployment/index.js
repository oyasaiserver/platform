...
export function dataCloudflareWorkersDeploymentAnnotationsToTerraform(struct) {
...
export function dataCloudflareWorkersDeploymentAnnotationsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareWorkersDeploymentVersionsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareWorkersDeploymentVersionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareWorkersDeployment extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _annotations = new DataCloudflareWorkersDeploymentAnnotationsOutputReference(this, "annotations");
    get annotations() {
    ...
    _versions = new DataCloudflareWorkersDeploymentVersionsList(this, "versions", false);
    get versions() {
