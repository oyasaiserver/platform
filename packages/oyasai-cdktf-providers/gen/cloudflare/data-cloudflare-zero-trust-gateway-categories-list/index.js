...
export function dataCloudflareZeroTrustGatewayCategoriesListResultSubcategoriesToTerraform(struct) {
...
export function dataCloudflareZeroTrustGatewayCategoriesListResultSubcategoriesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustGatewayCategoriesListResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustGatewayCategoriesListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustGatewayCategoriesListResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _subcategories = new DataCloudflareZeroTrustGatewayCategoriesListResultSubcategoriesList(this, "subcategories", false);
    get subcategories() {
...
export class DataCloudflareZeroTrustGatewayCategoriesList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_gateway_categories_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustGatewayCategoriesListResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
