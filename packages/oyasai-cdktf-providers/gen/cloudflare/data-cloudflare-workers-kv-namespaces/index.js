...
export function dataCloudflareWorkersKvNamespacesResultToTerraform(struct) {
...
export function dataCloudflareWorkersKvNamespacesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareWorkersKvNamespaces extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_workers_kv_namespaces";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareWorkersKvNamespacesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
