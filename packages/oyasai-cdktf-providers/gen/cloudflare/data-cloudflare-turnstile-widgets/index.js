...
export function dataCloudflareTurnstileWidgetsResultToTerraform(struct) {
...
export function dataCloudflareTurnstileWidgetsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareTurnstileWidgets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_turnstile_widgets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareTurnstileWidgetsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
