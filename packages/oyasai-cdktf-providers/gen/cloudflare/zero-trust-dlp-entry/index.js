...
export function zeroTrustDlpEntryConfidenceToTerraform(struct) {
...
export function zeroTrustDlpEntryConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryProfilesToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryProfilesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function zeroTrustDlpEntryVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class ZeroTrustDlpEntry extends cdktf.TerraformResource {
    ...
    */
    ...
    _confidence = new ZeroTrustDlpEntryConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new ZeroTrustDlpEntryPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _profiles = new ZeroTrustDlpEntryProfilesList(this, "profiles", false);
    get profiles() {
    ...
    _variant = new ZeroTrustDlpEntryVariantOutputReference(this, "variant");
    get variant() {
