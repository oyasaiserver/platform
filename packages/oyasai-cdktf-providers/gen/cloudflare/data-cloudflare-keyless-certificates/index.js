...
export function dataCloudflareKeylessCertificatesResultTunnelToTerraform(struct) {
...
export function dataCloudflareKeylessCertificatesResultTunnelToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareKeylessCertificatesResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareKeylessCertificatesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareKeylessCertificatesResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _tunnel = new DataCloudflareKeylessCertificatesResultTunnelOutputReference(this, "tunnel");
    get tunnel() {
        return this._tunnel;
    }
}
...
export class DataCloudflareKeylessCertificates extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_keyless_certificates";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareKeylessCertificatesResultList(this, "result", false);
    get result() {
        return this._result;
    }
