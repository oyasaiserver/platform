...
exports.DataCloudflareArgoTieredCaching = void 0;
...
*/
var DataCloudflareArgoTieredCaching = /** @class */ (function (_super) {
    __extends(DataCloudflareArgoTieredCaching, _super);
    // ===========
    // INITIALIZER
    // ===========
    /**
    ...
    */
    function DataCloudflareArgoTieredCaching(scope, id, config) {
    ...
    */
    DataCloudflareArgoTieredCaching.generateConfigForImport = function (scope, importToId, importFromId, provider) {
    ...
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "editable", {
        // ==========
        // ATTRIBUTES
        // ==========
    ...
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "id", {
    ...
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "modifiedOn", {
    ...
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "value", {
    ...
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "zoneId", {
        get: function () {
    ...
    DataCloudflareArgoTieredCaching.prototype.resetZoneId = function () {
        this._zoneId = undefined;
    };
    Object.defineProperty(DataCloudflareArgoTieredCaching.prototype, "zoneIdInput", {
    ...
    // SYNTHESIS
    // =========
    DataCloudflareArgoTieredCaching.prototype.synthesizeAttributes = function () {
        return {
            zone_id: cdktf.stringToTerraform(this._zoneId),
        };
    };
    DataCloudflareArgoTieredCaching.prototype.synthesizeHclAttributes = function () {
        var attrs = {
            zone_id: {
    ...
    // STATIC PROPERTIES
    // =================
    DataCloudflareArgoTieredCaching.tfResourceType = "cloudflare_argo_tiered_caching";
    return DataCloudflareArgoTieredCaching;
}(cdktf.TerraformDataSource));
exports.DataCloudflareArgoTieredCaching = DataCloudflareArgoTieredCaching;
