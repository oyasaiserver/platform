...
export function dataCloudflareWeb3HostnamesResultToTerraform(struct) {
...
export function dataCloudflareWeb3HostnamesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareWeb3Hostnames extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_web3_hostnames";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareWeb3HostnamesResultList(this, "result", false);
    get result() {
        return this._result;
    }
