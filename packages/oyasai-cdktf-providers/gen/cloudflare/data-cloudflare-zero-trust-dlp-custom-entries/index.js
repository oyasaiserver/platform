...
export function dataCloudflareZeroTrustDlpCustomEntriesResultConfidenceToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpCustomEntriesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpCustomEntriesResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _confidence = new DataCloudflareZeroTrustDlpCustomEntriesResultConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new DataCloudflareZeroTrustDlpCustomEntriesResultPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _variant = new DataCloudflareZeroTrustDlpCustomEntriesResultVariantOutputReference(this, "variant");
    get variant() {
...
export class DataCloudflareZeroTrustDlpCustomEntries extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_dlp_custom_entries";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustDlpCustomEntriesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
