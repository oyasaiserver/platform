...
export function dataCloudflareDnsZoneTransfersTsigsResultToTerraform(struct) {
...
export function dataCloudflareDnsZoneTransfersTsigsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareDnsZoneTransfersTsigs extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_dns_zone_transfers_tsigs";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareDnsZoneTransfersTsigsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
