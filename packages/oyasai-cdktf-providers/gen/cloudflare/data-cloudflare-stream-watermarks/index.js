...
export function dataCloudflareStreamWatermarksResultToTerraform(struct) {
...
export function dataCloudflareStreamWatermarksResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareStreamWatermarks extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_stream_watermarks";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareStreamWatermarksResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
