...
export function dataCloudflarePagesDomainsResultValidationDataToTerraform(struct) {
...
export function dataCloudflarePagesDomainsResultValidationDataToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflarePagesDomainsResultVerificationDataToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflarePagesDomainsResultVerificationDataToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflarePagesDomainsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflarePagesDomainsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflarePagesDomainsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _validationData = new DataCloudflarePagesDomainsResultValidationDataOutputReference(this, "validation_data");
    get validationData() {
        return this._validationData;
    }
    // verification_data - computed: true, optional: false, required: false
    _verificationData = new DataCloudflarePagesDomainsResultVerificationDataOutputReference(this, "verification_data");
...
export class DataCloudflarePagesDomains extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_pages_domains";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflarePagesDomainsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
