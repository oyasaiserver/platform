...
export function dataCloudflareMtlsCertificatesResultToTerraform(struct) {
...
export function dataCloudflareMtlsCertificatesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareMtlsCertificates extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_mtls_certificates";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareMtlsCertificatesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
