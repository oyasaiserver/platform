...
export function dataCloudflareDnsZoneTransfersAclsResultToTerraform(struct) {
...
export function dataCloudflareDnsZoneTransfersAclsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareDnsZoneTransfersAcls extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_dns_zone_transfers_acls";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareDnsZoneTransfersAclsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
