...
export function emailRoutingCatchAllActionsToTerraform(struct) {
...
export function emailRoutingCatchAllActionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function emailRoutingCatchAllMatchersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function emailRoutingCatchAllMatchersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class EmailRoutingCatchAll extends cdktf.TerraformResource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_email_routing_catch_all";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _actions = new EmailRoutingCatchAllActionsList(this, "actions", false);
    get actions() {
    ...
    _matchers = new EmailRoutingCatchAllMatchersList(this, "matchers", false);
    get matchers() {
