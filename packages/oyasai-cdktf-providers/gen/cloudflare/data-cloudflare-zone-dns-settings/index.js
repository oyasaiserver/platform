...
export function dataCloudflareZoneDnsSettingsInternalDnsToTerraform(struct) {
...
export function dataCloudflareZoneDnsSettingsInternalDnsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZoneDnsSettingsNameserversToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZoneDnsSettingsNameserversToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZoneDnsSettingsSoaToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZoneDnsSettingsSoaToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZoneDnsSettings extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _internalDns = new DataCloudflareZoneDnsSettingsInternalDnsOutputReference(this, "internal_dns");
    get internalDns() {
    ...
    _nameservers = new DataCloudflareZoneDnsSettingsNameserversOutputReference(this, "nameservers");
    get nameservers() {
    ...
    _soa = new DataCloudflareZoneDnsSettingsSoaOutputReference(this, "soa");
    get soa() {
        return this._soa;
    }
