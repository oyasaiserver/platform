...
export function accountSubscriptionRatePlanToTerraform(struct) {
...
export function accountSubscriptionRatePlanToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class AccountSubscription extends cdktf.TerraformResource {
    ...
    */
    ...
    _ratePlan = new AccountSubscriptionRatePlanOutputReference(this, "rate_plan");
    get ratePlan() {
