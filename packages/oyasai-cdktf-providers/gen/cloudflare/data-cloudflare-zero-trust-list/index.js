...
export function dataCloudflareZeroTrustListFilterToTerraform(struct) {
...
export function dataCloudflareZeroTrustListFilterToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustListItemsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustListItemsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustList extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _filter = new DataCloudflareZeroTrustListFilterOutputReference(this, "filter");
    get filter() {
        return this._filter;
    }
    putFilter(value) {
    ...
    _items = new DataCloudflareZeroTrustListItemsList(this, "items", true);
    get items() {
        return this._items;
    }
