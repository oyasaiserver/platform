...
*/
export declare class DataCloudflareZeroTrustDeviceDefaultProfileCertificates extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareZeroTrustDeviceDefaultProfileCertificatesConfig);
    get enabled(): any;
    private _zoneId?;
    get zoneId(): string;
