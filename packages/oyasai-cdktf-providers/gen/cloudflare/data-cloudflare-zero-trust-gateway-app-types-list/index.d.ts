...
export declare function dataCloudflareZeroTrustGatewayAppTypesListResultToTerraform(struct?: DataCloudflareZeroTrustGatewayAppTypesListResult): any;
export declare function dataCloudflareZeroTrustGatewayAppTypesListResultToHclTerraform(struct?: DataCloudflareZeroTrustGatewayAppTypesListResult): any;
export declare class DataCloudflareZeroTrustGatewayAppTypesListResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataCloudflareZeroTrustGatewayAppTypesListResult | undefined;
    set internalValue(value: DataCloudflareZeroTrustGatewayAppTypesListResult | undefined);
    get applicationTypeId(): any;
    get createdAt(): any;
    get description(): any;
    get id(): any;
    get name(): any;
}
export declare class DataCloudflareZeroTrustGatewayAppTypesListResultList extends cdktf.ComplexList {
    ...
    */
    get(index: number): DataCloudflareZeroTrustGatewayAppTypesListResultOutputReference;
}
/**
...
*/
export declare class DataCloudflareZeroTrustGatewayAppTypesList extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "cloudflare_zero_trust_gateway_app_types_list";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareZeroTrustGatewayAppTypesListConfig);
    private _accountId?;
    ...
    private _result;
    get result(): DataCloudflareZeroTrustGatewayAppTypesListResultList;
