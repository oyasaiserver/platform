...
export function dataCloudflareZeroTrustGatewayAppTypesListResultToTerraform(struct) {
...
export function dataCloudflareZeroTrustGatewayAppTypesListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustGatewayAppTypesList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_gateway_app_types_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustGatewayAppTypesListResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
