...
export function dataCloudflareSsoConnectorsResultVerificationToTerraform(struct) {
...
export function dataCloudflareSsoConnectorsResultVerificationToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareSsoConnectorsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareSsoConnectorsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareSsoConnectorsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _verification = new DataCloudflareSsoConnectorsResultVerificationOutputReference(this, "verification");
    get verification() {
...
export class DataCloudflareSsoConnectors extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_sso_connectors";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareSsoConnectorsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
