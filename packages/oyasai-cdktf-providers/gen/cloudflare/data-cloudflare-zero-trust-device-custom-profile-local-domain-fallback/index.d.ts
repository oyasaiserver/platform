...
*/
export declare class DataCloudflareZeroTrustDeviceCustomProfileLocalDomainFallback extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataCloudflareZeroTrustDeviceCustomProfileLocalDomainFallbackConfig);
    private _accountId?;
