...
export function dataCloudflareLogpushDatasetJobOutputOptionsToTerraform(struct) {
...
export function dataCloudflareLogpushDatasetJobOutputOptionsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareLogpushDatasetJob extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_logpush_dataset_job";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _outputOptions = new DataCloudflareLogpushDatasetJobOutputOptionsOutputReference(this, "output_options");
    get outputOptions() {
