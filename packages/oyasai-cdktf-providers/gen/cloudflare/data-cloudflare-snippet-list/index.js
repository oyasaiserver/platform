...
export function dataCloudflareSnippetListResultToTerraform(struct) {
...
export function dataCloudflareSnippetListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareSnippetList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_snippet_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareSnippetListResultList(this, "result", false);
    get result() {
        return this._result;
    }
