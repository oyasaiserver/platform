...
export function dataCloudflareTokenValidationConfigsResultCredentialsKeysToTerraform(struct) {
...
export function dataCloudflareTokenValidationConfigsResultCredentialsKeysToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareTokenValidationConfigsResultCredentialsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareTokenValidationConfigsResultCredentialsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareTokenValidationConfigsResultCredentialsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _keys = new DataCloudflareTokenValidationConfigsResultCredentialsKeysList(this, "keys", false);
    get keys() {
        return this._keys;
    }
}
export function dataCloudflareTokenValidationConfigsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareTokenValidationConfigsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareTokenValidationConfigsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _credentials = new DataCloudflareTokenValidationConfigsResultCredentialsOutputReference(this, "credentials");
    get credentials() {
...
export class DataCloudflareTokenValidationConfigs extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_token_validation_configs";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareTokenValidationConfigsResultList(this, "result", false);
    get result() {
        return this._result;
    }
