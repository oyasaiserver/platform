...
export function dataCloudflareZeroTrustDlpDatasetsResultColumnsToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpDatasetsResultColumnsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpDatasetsResultUploadsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpDatasetsResultUploadsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpDatasetsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpDatasetsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpDatasetsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _columns = new DataCloudflareZeroTrustDlpDatasetsResultColumnsList(this, "columns", false);
    get columns() {
    ...
    _uploads = new DataCloudflareZeroTrustDlpDatasetsResultUploadsList(this, "uploads", false);
    get uploads() {
...
export class DataCloudflareZeroTrustDlpDatasets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_dlp_datasets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustDlpDatasetsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
