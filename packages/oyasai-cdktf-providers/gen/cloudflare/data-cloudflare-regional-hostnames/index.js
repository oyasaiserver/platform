...
export function dataCloudflareRegionalHostnamesResultToTerraform(struct) {
...
export function dataCloudflareRegionalHostnamesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareRegionalHostnames extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_regional_hostnames";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareRegionalHostnamesResultList(this, "result", false);
    get result() {
        return this._result;
    }
