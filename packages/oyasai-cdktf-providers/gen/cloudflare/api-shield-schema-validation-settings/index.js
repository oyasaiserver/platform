...
*/
var ApiShieldSchemaValidationSettings = /** @class */ (function (_super) {
    __extends(ApiShieldSchemaValidationSettings, _super);
    // ===========
    // INITIALIZER
    // ===========
    /**
    ...
    */
    function ApiShieldSchemaValidationSettings(scope, id, config) {
    ...
    */
    ApiShieldSchemaValidationSettings.generateConfigForImport = function (scope, importToId, importFromId, provider) {
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "id", {
        // ==========
        // ATTRIBUTES
        // ==========
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "validationDefaultMitigationAction", {
        get: function () {
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "validationDefaultMitigationActionInput", {
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "validationOverrideMitigationAction", {
        get: function () {
    ...
    ApiShieldSchemaValidationSettings.prototype.resetValidationOverrideMitigationAction = function () {
        this._validationOverrideMitigationAction = undefined;
    };
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "validationOverrideMitigationActionInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "zoneId", {
        get: function () {
    ...
    Object.defineProperty(ApiShieldSchemaValidationSettings.prototype, "zoneIdInput", {
        // Temporarily expose input value. Use with caution.
        get: function () {
            return this._zoneId;
        },
    ...
    // SYNTHESIS
    // =========
    ApiShieldSchemaValidationSettings.prototype.synthesizeAttributes = function () {
        return {
    ...
    ApiShieldSchemaValidationSettings.prototype.synthesizeHclAttributes = function () {
        var attrs = {
    ...
    // STATIC PROPERTIES
    // =================
    ApiShieldSchemaValidationSettings.tfResourceType = "cloudflare_api_shield_schema_validation_settings";
