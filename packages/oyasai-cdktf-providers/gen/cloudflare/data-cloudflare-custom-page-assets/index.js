...
export function dataCloudflareCustomPageAssetsResultToTerraform(struct) {
...
export function dataCloudflareCustomPageAssetsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareCustomPageAssets extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_custom_page_assets";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareCustomPageAssetsResultList(this, "result", false);
    get result() {
        return this._result;
    }
