...
export function dataCloudflareWorkersCronTriggerSchedulesToTerraform(struct) {
...
export function dataCloudflareWorkersCronTriggerSchedulesToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareWorkersCronTrigger extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _schedules = new DataCloudflareWorkersCronTriggerSchedulesList(this, "schedules", false);
    get schedules() {
