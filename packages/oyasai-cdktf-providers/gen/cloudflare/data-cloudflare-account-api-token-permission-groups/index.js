...
export function dataCloudflareAccountApiTokenPermissionGroupsPermissionGroupsToTerraform(struct) {
...
export function dataCloudflareAccountApiTokenPermissionGroupsPermissionGroupsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareAccountApiTokenPermissionGroups extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_account_api_token_permission_groups";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _permissionGroups = new DataCloudflareAccountApiTokenPermissionGroupsPermissionGroupsList(this, "permission_groups", false);
