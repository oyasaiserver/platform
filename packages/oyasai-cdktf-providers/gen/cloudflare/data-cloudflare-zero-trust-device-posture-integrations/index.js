...
export function dataCloudflareZeroTrustDevicePostureIntegrationsResultConfigToTerraform(struct) {
...
export function dataCloudflareZeroTrustDevicePostureIntegrationsResultConfigToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDevicePostureIntegrationsResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDevicePostureIntegrationsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDevicePostureIntegrationsResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _config = new DataCloudflareZeroTrustDevicePostureIntegrationsResultConfigOutputReference(this, "config");
    get config() {
        return this._config;
    }
...
export class DataCloudflareZeroTrustDevicePostureIntegrations extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_device_posture_integrations";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustDevicePostureIntegrationsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
