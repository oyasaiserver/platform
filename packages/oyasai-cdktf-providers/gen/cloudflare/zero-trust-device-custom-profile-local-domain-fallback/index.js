...
export function zeroTrustDeviceCustomProfileLocalDomainFallbackDomainsToTerraform(struct) {
...
export function zeroTrustDeviceCustomProfileLocalDomainFallbackDomainsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class ZeroTrustDeviceCustomProfileLocalDomainFallback extends cdktf.TerraformResource {
    ...
    */
    ...
    _domains = new ZeroTrustDeviceCustomProfileLocalDomainFallbackDomainsList(this, "domains", true);
    get domains() {
