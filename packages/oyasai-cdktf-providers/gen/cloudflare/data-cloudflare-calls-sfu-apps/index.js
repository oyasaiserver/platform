...
export function dataCloudflareCallsSfuAppsResultToTerraform(struct) {
...
export function dataCloudflareCallsSfuAppsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareCallsSfuApps extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_calls_sfu_apps";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareCallsSfuAppsResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
