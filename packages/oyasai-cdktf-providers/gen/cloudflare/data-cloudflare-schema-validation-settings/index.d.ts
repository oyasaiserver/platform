...
*/
export declare class DataCloudflareSchemaValidationSettings extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config?: DataCloudflareSchemaValidationSettingsConfig);
