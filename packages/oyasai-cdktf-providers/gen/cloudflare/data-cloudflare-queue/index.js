...
export function dataCloudflareQueueConsumersSettingsToTerraform(struct) {
...
export function dataCloudflareQueueConsumersSettingsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueConsumersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueConsumersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareQueueConsumersOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _settings = new DataCloudflareQueueConsumersSettingsOutputReference(this, "settings");
    get settings() {
...
export function dataCloudflareQueueProducersToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueProducersToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueSettingsToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueSettingsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareQueue extends cdktf.TerraformDataSource {
    ...
    */
    ...
    _consumers = new DataCloudflareQueueConsumersList(this, "consumers", false);
    get consumers() {
    ...
    _producers = new DataCloudflareQueueProducersList(this, "producers", false);
    get producers() {
    ...
    // settings - computed: true, optional: false, required: false
    _settings = new DataCloudflareQueueSettingsOutputReference(this, "settings");
    get settings() {
        return this._settings;
    }
    // =========
