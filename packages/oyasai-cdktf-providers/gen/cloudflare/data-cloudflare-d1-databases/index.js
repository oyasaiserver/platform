...
export function dataCloudflareD1DatabasesResultToTerraform(struct) {
...
export function dataCloudflareD1DatabasesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareD1Databases extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_d1_databases";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareD1DatabasesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
