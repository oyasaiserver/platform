...
export function dataCloudflareSnippetRulesListResultToTerraform(struct) {
...
export function dataCloudflareSnippetRulesListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareSnippetRulesList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_snippet_rules_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareSnippetRulesListResultList(this, "result", false);
    get result() {
        return this._result;
    }
