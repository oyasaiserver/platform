...
export function dataCloudflareContentScanningExpressionsResultToTerraform(struct) {
...
export function dataCloudflareContentScanningExpressionsResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareContentScanningExpressions extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_content_scanning_expressions";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareContentScanningExpressionsResultList(this, "result", false);
    get result() {
        return this._result;
    }
