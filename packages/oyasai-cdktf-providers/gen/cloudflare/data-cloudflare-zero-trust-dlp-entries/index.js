...
export function dataCloudflareZeroTrustDlpEntriesResultConfidenceToTerraform(struct) {
...
export function dataCloudflareZeroTrustDlpEntriesResultConfidenceToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultPatternToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultPatternToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultVariantToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultVariantToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareZeroTrustDlpEntriesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareZeroTrustDlpEntriesResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _confidence = new DataCloudflareZeroTrustDlpEntriesResultConfidenceOutputReference(this, "confidence");
    get confidence() {
    ...
    _pattern = new DataCloudflareZeroTrustDlpEntriesResultPatternOutputReference(this, "pattern");
    get pattern() {
    ...
    _variant = new DataCloudflareZeroTrustDlpEntriesResultVariantOutputReference(this, "variant");
    get variant() {
...
export class DataCloudflareZeroTrustDlpEntries extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_zero_trust_dlp_entries";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareZeroTrustDlpEntriesResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
