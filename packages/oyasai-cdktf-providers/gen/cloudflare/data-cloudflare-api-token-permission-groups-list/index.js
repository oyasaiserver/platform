...
export function dataCloudflareApiTokenPermissionGroupsListResultToTerraform(struct) {
...
export function dataCloudflareApiTokenPermissionGroupsListResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareApiTokenPermissionGroupsList extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_api_token_permission_groups_list";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareApiTokenPermissionGroupsListResultList(this, "result", false);
    get result() {
        return this._result;
    }
