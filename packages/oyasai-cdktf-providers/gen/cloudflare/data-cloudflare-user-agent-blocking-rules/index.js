...
export function dataCloudflareUserAgentBlockingRulesResultConfigurationToTerraform(struct) {
...
export function dataCloudflareUserAgentBlockingRulesResultConfigurationToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareUserAgentBlockingRulesResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareUserAgentBlockingRulesResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareUserAgentBlockingRulesResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _configuration = new DataCloudflareUserAgentBlockingRulesResultConfigurationOutputReference(this, "configuration");
    get configuration() {
...
export class DataCloudflareUserAgentBlockingRules extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_user_agent_blocking_rules";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareUserAgentBlockingRulesResultList(this, "result", false);
    get result() {
        return this._result;
    }
