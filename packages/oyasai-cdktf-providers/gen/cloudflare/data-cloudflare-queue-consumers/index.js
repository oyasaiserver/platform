...
export function dataCloudflareQueueConsumersResultSettingsToTerraform(struct) {
...
export function dataCloudflareQueueConsumersResultSettingsToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueConsumersResultToTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export function dataCloudflareQueueConsumersResultToHclTerraform(struct) {
    if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
        return struct;
    }
    if (cdktf.isComplexElement(struct)) {
...
export class DataCloudflareQueueConsumersResultOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    _settings = new DataCloudflareQueueConsumersResultSettingsOutputReference(this, "settings");
    get settings() {
...
export class DataCloudflareQueueConsumersA extends cdktf.TerraformDataSource {
    ...
    // STATIC PROPERTIES
    // =================
    static tfResourceType = "cloudflare_queue_consumers";
    // ==============
    // STATIC Methods
    // ==============
    /**
    ...
    */
    ...
    _result = new DataCloudflareQueueConsumersResultList(this, "result", false);
    get result() {
        return this._result;
    }
    // =========
