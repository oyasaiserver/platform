// https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_load_test
...
export interface DataGrafanaK6LoadTestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_load_test#id DataGrafanaK6LoadTest#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_load_test grafana_k6_load_test}
*/
export class DataGrafanaK6LoadTest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6LoadTest that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_load_test#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_load_test grafana_k6_load_test} Data Source
  *
  * @param scope The scope in which to define this construct
