// https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_schedules
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_schedules grafana_k6_schedules}
*/
export class DataGrafanaK6Schedules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6Schedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.46.0/docs/data-sources/k6_schedules grafana_k6_schedules} Data Source
  *
  * @param scope The scope in which to define this construct
