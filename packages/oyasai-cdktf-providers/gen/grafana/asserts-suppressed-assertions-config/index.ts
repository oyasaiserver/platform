// https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config
...
export interface AssertsSuppressedAssertionsConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config#match_labels AssertsSuppressedAssertionsConfig#match_labels}
  */
  readonly matchLabels?: { [key: string]: string };
  /**
  * The name of the disabled alert configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config#name AssertsSuppressedAssertionsConfig#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config grafana_asserts_suppressed_assertions_config}
*/
export class AssertsSuppressedAssertionsConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssertsSuppressedAssertionsConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.45.2/docs/resources/asserts_suppressed_assertions_config grafana_asserts_suppressed_assertions_config} Resource
  *
  * @param scope The scope in which to define this construct
