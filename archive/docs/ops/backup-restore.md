...
v2.5.0 | | 最終更新日 | 2026-03-29 |

______________________________________________________________________

## バックアップ対象

| パス | 内容 | 優先度 | |---|---|---| | `plugins/OyasaiPets/players/` |
全プレイヤーのペットデータ（JSON） | 最高 | | `plugins/OyasaiPets/config.yml` | プラグイン設定 | 高 |
...
1. バックアップから対象プレイヤーディレクトリをコピーする
   ...
   ```
1. サーバーを起動する
1. 対象プレイヤーが `/bigwolf history` でペットを確認できることを検証する
