...
class GoldenTest :
    FunSpec({
      ...
      context("artifacts") { golden("artifacts/sources-javadoc", "-a", "sources,javadoc") }
      context("basic") {
        golden("basic/basic-java-project")
        golden("basic/basic-kotlin-project")
      }
      context("buildsrc") { golden("buildsrc/plugin-in-buildsrc") }
      context("dependency") {
      ...
      context("included-build") { golden("included-build") }
      context("integration") { golden("integration/settings-buildscript") }
      context("ivy") { golden("ivy/basic") }
      context("plugin") { golden("plugin/resolves-from-default-repo") }
      ...
      context("subprojects") { golden("subprojects/multi-module") }
    })
