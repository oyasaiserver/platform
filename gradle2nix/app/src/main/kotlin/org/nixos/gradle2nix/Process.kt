...
fun processDependencies(
    ...
    buildMap<DependencyCoordinates, Map<String, Artifact>> {
        ...
        .mapValues { (_, artifacts) -> artifacts.toSortedMap() }
...
private fun DependencySet.toEnv(): Map<DependencyCoordinates, Map<String, Artifact>> =
    dependencies.associate { dep ->
      dep.coordinates to dep.artifacts.associate { it.name to Artifact(it.url, it.hash.toSri()) }
    }

@OptIn(ExperimentalEncodingApi::class, ExperimentalStdlibApi::class)
internal fun String.toSri(): String = buildString {
  append("sha256-")
