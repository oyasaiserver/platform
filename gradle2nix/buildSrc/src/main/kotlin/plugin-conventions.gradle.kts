...
configurations { "api" { dependencies.remove(project.dependencies.gradleApi()) } }
...
tasks {
  ...
  named("shadowJar", ShadowJar::class) {
    ...
    filesMatching("**/bin/*") { filePermissions { unix("755") } }
    filesMatching("**/bin/*.bat") { filePermissions { unix("644") } }
    ...
    dependencies {
      ...
      exclude {
        it.moduleGroup == "org.jetbrains.kotlin" && it.moduleName == "kotlin-stdlib-common"
      }
      ...
      exclude {
        it.moduleGroup == "org.jetbrains.kotlin" && it.moduleName == "kotlin-script-runtime"
      }
    }
  }
}
