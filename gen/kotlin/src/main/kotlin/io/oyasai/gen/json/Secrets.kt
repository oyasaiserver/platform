...
data class Secrets(
    ...
    @SerialName("GITHUB_APP_ID") val githubAppId: String,
    @SerialName("GITHUB_APP_INSTALLATION_ID") val githubAppInstallationId: String,
    @SerialName("GITHUB_APP_PEM_FILE") val githubAppPemFile: String,
