...
export const composeSpec = z
  .object({
    ...
    include: z
      .array(z.any())
      .describe('compose sub-projects to be included.')
      .optional(),
    services: z
      .record(z.union([z.any(), z.never()]))
    ...
    models: z
      ...
      .describe('Language models that will be used by your application.')
      .optional(),
    networks: z
      .record(z.any())
      .superRefine((value, ctx) => {
      ...
      .describe('Networks that are shared among multiple services.')
      .optional(),
    volumes: z
      .record(z.union([z.any(), z.never()]))
      .superRefine((value, ctx) => {
  ...
  ) satisfies z.ZodType<ComposeSpec>
